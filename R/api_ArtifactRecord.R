#' @title APIArtifactRecord
#'
#' @noRd
#'
#' @description
#' A record that represents an artifact.
APIArtifactRecord <- R6::R6Class( # nolint object_name_linter
  "APIArtifactRecord",
  inherit = APIRecord,
  public = list(
    #' @description
    ...
    cache = function() {
      ...
      if (artifact_storage$type == "s3") {
        api_check_requires("Caching artifacts from s3", "s3")
    ...
    #' @description
    #' Print a more detailed description of an `APIArtifactRecord`
    #'
