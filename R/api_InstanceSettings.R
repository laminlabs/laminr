...
APIInstanceSettings <- R6::R6Class( # nolint object_name_linter
  "APIInstanceSettings",
  cloneable = FALSE,
  public = list(
    #' @description
    ...
    #' @description
    #' Create a string representation of an `APIInstanceSettings`
    #'
    #' @param style Logical, whether the output is styled using ANSI codes
    #'
    ...
    to_string = function(style = FALSE) {
      ...
      make_class_string("APIInstanceSettings", field_strings, style = style)
    }
  ),
  private = list(
    .settings = NULL
