api_create_module <- function(instance, api, module_name, module_schema) {
...
APIModule <- R6::R6Class( # nolint object_name_linter
  "APIModule",
  cloneable = FALSE,
  public = list(
    #' @description
    ...
    initialize = function(instance, api, module_name, module_schema) {
      ...
      private$.registry_classes <- purrr::map(
        names(module_schema),
        ...
        purrr::set_names(names(module_schema))
    },
    #' @description Get the registries in the module.
    #'
    #' @return A list of [APIRegistry] objects.
    ...
    #' @description
    #' Create a string representation of a `APIModule`
    #'
    #' @param style Logical, whether the output is styled using ANSI codes
    #'
