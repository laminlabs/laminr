...
APIUserSettings <- R6::R6Class( # nolint object_name_linter
  "APIUserSettings",
  cloneable = FALSE,
  public = list(
    #' @description
    ...
    #' @description
    #' Create a string representation of a `APIUserSettings`
    #'
    #' @param style Logical, whether the output is styled using ANSI codes
    #'
    ...
    to_string = function(style = FALSE) {
      ...
      make_class_string("APIUserSettings", field_strings, style = style)
    }
  ),
  private = list(
    .settings = NULL
