...
To connect to a LaminDB instance, you will first need to run `lamin login` OR `lamin load <instance>` in the terminal. This will create a `.lamin` file in your home directory with the necessary credentials.
