...
#> → connected lamindb: testuser1/laminr-intro-20251111134123
#> ℹ Requiring bionty
ln$track()
#> → created Transform('7R56qnkCRR2d0000', key='introduction.Rmd'), started new Run('o2cFT8NrP7YRj6un') at 2025-11-11 13:42:08 UTC
#> • recommendation: to identify the notebook across renames, pass the uid: ln$track("7R56qnkCRR2d")

ln$Transform$to_dataframe()
#>                uid              key description     type source_code hash
#> 1 7R56qnkCRR2d0000 introduction.Rmd        <NA> notebook        <NA> <NA>
#>   reference reference_type version is_latest is_locked          created_at
#> 1      <NA>           <NA>    <NA>      TRUE     FALSE 2025-11-11 13:42:08
#>   branch_id space_id created_by_id _template_id
#> 1         1        1             1         <NA>
ln$Run$to_dataframe()
#>                uid name          started_at finished_at params reference
#> 1 o2cFT8NrP7YRj6un <NA> 2025-11-11 13:42:08        <NA>   <NA>      <NA>
#>   reference_type is_locked          created_at branch_id space_id transform_id
#> 1           <NA>     FALSE 2025-11-11 13:42:08         1        1            1
...
#> ├── uid: qoTS8tT6CYlGBynH0000            run: o2cFT8N (introduction.Rmd)
#> │   kind: dataset                        otype: DataFrame               
#> │   hash: K2fp8FbA1YbQxsOrfXX_ig         size: 9.2 KB                   
#> │   branch: main                         space: all                     
#> │   created_at: 2025-11-11 13:42:10 UTC  created_by: testuser1          
#> │   n_observations: 3                                                   
#> └── storage/path: 
#>     /tmp/Rtmph3Qp5L/laminr-intro-20251111134123/.lamindb/qoTS8tT6CYlGBynH0000.pa
#>     rquet
```
...
#> sample3                      Chinese
artifact$cache()
#> [1] "/tmp/Rtmph3Qp5L/laminr-intro-20251111134123/.lamindb/qoTS8tT6CYlGBynH0000.parquet"
```
...
``` r
artifact$transform
#> Transform(uid='7R56qnkCRR2d0000', version=None, is_latest=True, key='introduction.Rmd', description=None, type='notebook', hash=None, reference=None, reference_type=None, branch_id=1, space_id=1, created_by_id=1, created_at=2025-11-11 13:42:08 UTC, is_locked=False)
artifact$run
#> Run(uid='o2cFT8NrP7YRj6un', name=None, started_at=2025-11-11 13:42:08 UTC, finished_at=None, params=None, reference=None, reference_type=None, branch_id=1, space_id=1, transform_id=1, report_id=None, environment_id=None, created_by_id=1, initiated_by_run_id=None, created_at=2025-11-11 13:42:08 UTC, is_locked=False)
...
#> 1 qoTS8tT6CYlGBynH0000 my_datasets/rnaseq1.parquet        <NA> .parquet dataset
#>       otype size                   hash n_files n_observations version
#> 1 DataFrame 9401 K2fp8FbA1YbQxsOrfXX_ig    <NA>              3    <NA>
#>   is_latest is_locked          created_at branch_id space_id storage_id run_id
#> 1      TRUE     FALSE 2025-11-11 13:42:10         1        1          1      1
...
#> Feature(uid='szTpupjIvGxS', name='temperature', dtype='float', is_type=None, unit=None, description=None, array_rank=0, array_size=0, array_shape=None, proxy_dtype=None, synonyms=None, branch_id=1, space_id=1, created_by_id=1, run_id=1, type_id=None, created_at=2025-11-11 13:42:30 UTC, is_locked=False)
ln$Feature(name = "experiment", dtype = ln$ULabel)$save()
#> Feature(uid='VL7GjONDXutw', name='experiment', dtype='cat[ULabel]', is_type=None, unit=None, description=None, array_rank=0, array_size=0, array_shape=None, proxy_dtype=None, synonyms=None, branch_id=1, space_id=1, created_by_id=1, run_id=1, type_id=None, created_at=2025-11-11 13:42:30 UTC, is_locked=False)
...
#> ULabel(uid='vaBCnDbJ', name='DMSO', is_type=False, description=None, reference=None, reference_type=None, branch_id=1, space_id=1, created_by_id=1, run_id=1, type_id=None, created_at=2025-11-11 13:42:30 UTC, is_locked=False)
ln$ULabel(name = "IFNG")$save()
#> ULabel(uid='OCKPffrV', name='IFNG', is_type=False, description=None, reference=None, reference_type=None, branch_id=1, space_id=1, created_by_id=1, run_id=1, type_id=None, created_at=2025-11-11 13:42:30 UTC, is_locked=False)

# define a few more valid features
ln$Feature(name = "perturbation", dtype = ln$ULabel)$save()
#> Feature(uid='Rbcb4J2FKaVh', name='perturbation', dtype='cat[ULabel]', is_type=None, unit=None, description=None, array_rank=0, array_size=0, array_shape=None, proxy_dtype=None, synonyms=None, branch_id=1, space_id=1, created_by_id=1, run_id=1, type_id=None, created_at=2025-11-11 13:42:31 UTC, is_locked=False)
ln$Feature(name = "cell_type_by_model", dtype = bt$CellType)$save()
#> Feature(uid='65N4UieHeh1h', name='cell_type_by_model', dtype='cat[bionty.CellType]', is_type=None, unit=None, description=None, array_rank=0, array_size=0, array_shape=None, proxy_dtype=None, synonyms=None, branch_id=1, space_id=1, created_by_id=1, run_id=1, type_id=None, created_at=2025-11-11 13:42:31 UTC, is_locked=False)
ln$Feature(name = "cell_type_by_expert", dtype = bt$CellType)$save()
#> Feature(uid='iUJuubIKft7P', name='cell_type_by_expert', dtype='cat[bionty.CellType]', is_type=None, unit=None, description=None, array_rank=0, array_size=0, array_shape=None, proxy_dtype=None, synonyms=None, branch_id=1, space_id=1, created_by_id=1, run_id=1, type_id=None, created_at=2025-11-11 13:42:31 UTC, is_locked=False)
ln$Feature(name = "assay_oid", dtype = bt$ExperimentalFactor$ontology_id)$save()
#> Feature(uid='GlrpUZ9aL3rd', name='assay_oid', dtype='cat[bionty.ExperimentalFactor.ontology_id]', is_type=None, unit=None, description=None, array_rank=0, array_size=0, array_shape=None, proxy_dtype=None, synonyms=None, branch_id=1, space_id=1, created_by_id=1, run_id=1, type_id=None, created_at=2025-11-11 13:42:31 UTC, is_locked=False)
ln$Feature(name = "donor", dtype = "str", nullable = TRUE)$save()
#> Feature(uid='QIug0EoY4Ynd', name='donor', dtype='str', is_type=None, unit=None, description=None, array_rank=0, array_size=0, array_shape=None, proxy_dtype=None, synonyms=None, branch_id=1, space_id=1, created_by_id=1, run_id=1, type_id=None, created_at=2025-11-11 13:42:32 UTC, is_locked=False)
ln$Feature(name = "concentration", dtype = "str")$save()
#> Feature(uid='V5YYeea53oP1', name='concentration', dtype='str', is_type=None, unit=None, description=None, array_rank=0, array_size=0, array_shape=None, proxy_dtype=None, synonyms=None, branch_id=1, space_id=1, created_by_id=1, run_id=1, type_id=None, created_at=2025-11-11 13:42:32 UTC, is_locked=False)
ln$Feature(name = "treatment_time_h", dtype = "num", coerce_dtype = TRUE)$save()
#> Feature(uid='JKkC1UYWfaYf', name='treatment_time_h', dtype='num', is_type=None, unit=None, description=None, array_rank=0, array_size=0, array_shape=None, proxy_dtype=None, synonyms=None, branch_id=1, space_id=1, created_by_id=1, run_id=1, type_id=None, created_at=2025-11-11 13:42:32 UTC, is_locked=False)
...
#> → writing the in-memory object into cache
#> → returning artifact with same hash: Artifact(uid='qoTS8tT6CYlGBynH0000', version=None, is_latest=True, key='my_datasets/rnaseq1.parquet', description=None, suffix='.parquet', kind='dataset', otype='DataFrame', size=9401, hash='K2fp8FbA1YbQxsOrfXX_ig', n_files=None, n_observations=3, branch_id=1, space_id=1, storage_id=1, run_id=1, schema_id=None, created_by_id=1, created_at=2025-11-11 13:42:10 UTC, is_locked=False); to track this artifact as an input, use: ln.Artifact.get()
...
#> ... synchronizing df_all__efo__3.70.0__ExperimentalFactor.parquet:  0.0%... synchronizing df_all__efo__3.70.0__ExperimentalFactor.parquet:  0.9%... synchronizing df_all__efo__3.70.0__ExperimentalFactor.parquet:  4.6%... synchronizing df_all__efo__3.70.0__ExperimentalFactor.parquet:  5.8%... synchronizing df_all__efo__3.70.0__ExperimentalFactor.parquet:  9.5%... synchronizing df_all__efo__3.70.0__ExperimentalFactor.parquet: 13.1%... synchronizing df_all__efo__3.70.0__ExperimentalFactor.parquet: 16.7%... synchronizing df_all__efo__3.70.0__ExperimentalFactor.parquet: 20.3%... synchronizing df_all__efo__3.70.0__ExperimentalFactor.parquet: 23.9%... synchronizing df_all__efo__3.70.0__ExperimentalFactor.parquet: 27.5%... synchronizing df_all__efo__3.70.0__ExperimentalFactor.parquet: 31.2%... synchronizing df_all__efo__3.70.0__ExperimentalFactor.parquet: 34.7%... synchronizing df_all__efo__3.70.0__ExperimentalFactor.parquet: 38.3%... synchronizing df_all__efo__3.70.0__ExperimentalFactor.parquet: 42.0%... synchronizing df_all__efo__3.70.0__ExperimentalFactor.parquet: 45.6%... synchronizing df_all__efo__3.70.0__ExperimentalFactor.parquet: 49.2%... synchronizing df_all__efo__3.70.0__ExperimentalFactor.parquet: 52.8%... synchronizing df_all__efo__3.70.0__ExperimentalFactor.parquet: 56.4%... synchronizing df_all__efo__3.70.0__ExperimentalFactor.parquet: 60.0%... synchronizing df_all__efo__3.70.0__ExperimentalFactor.parquet: 63.6%... synchronizing df_all__efo__3.70.0__ExperimentalFactor.parquet: 67.2%... synchronizing df_all__efo__3.70.0__ExperimentalFactor.parquet: 70.8%... synchronizing df_all__efo__3.70.0__ExperimentalFactor.parquet: 74.5%... synchronizing df_all__efo__3.70.0__ExperimentalFactor.parquet: 78.0%... synchronizing df_all__efo__3.70.0__ExperimentalFactor.parquet: 81.7%... synchronizing df_all__efo__3.70.0__ExperimentalFactor.parquet: 85.3%... synchronizing df_all__efo__3.70.0__ExperimentalFactor.parquet: 88.9%... synchronizing df_all__efo__3.70.0__ExperimentalFactor.parquet: 92.5%... synchronizing df_all__efo__3.70.0__ExperimentalFactor.parquet: 96.1%... synchronizing df_all__efo__3.70.0__ExperimentalFactor.parquet: 99.7%... synchronizing df_all__efo__3.70.0__ExperimentalFactor.parquet: 100.0%
```
...
#> → writing the in-memory object into cache
#> → creating new artifact version for key 'my_datasets/rnaseq1.parquet' in storage '/tmp/Rtmph3Qp5L/laminr-intro-20251111134123'
#> → loading artifact into memory for validation
#> ! 5 terms not validated in feature 'columns': 'ENSG00000153563', 'ENSG00000010610', 'ENSG00000170458', 'sample_note', 'donor_ethnicity'
#>     → fix typos, remove non-existent values, or save terms via: curator.cat.add_new_from('columns')
...
#> ├── uid: qoTS8tT6CYlGBynH0001            run: o2cFT8N (introduction.Rmd)
#> │   kind: dataset                        otype: DataFrame               
#> │   hash: ebsyI2UUcC-leVTnot_2vg         size: 9.2 KB                   
#> │   branch: main                         space: all                     
#> │   created_at: 2025-11-11 13:43:38 UTC  created_by: testuser1          
#> │   n_observations: 3                                                   
#> ├── storage/path: 
#> │   /tmp/Rtmph3Qp5L/laminr-intro-20251111134123/.lamindb/qoTS8tT6CYlGBynH0001.pa
#> │   rquet
#> ├── Dataset features
#> │   └── columns (7)                                                             
...
artifact$schema
#> Schema(uid='0000000000000000', name=None, description=None, is_type=False, itype='Feature', otype=None, dtype=None, hash='kMi7B_N88uu-YnbTLDU-DA', minimal_set=True, ordered_set=False, maximal_set=False, slot=None, branch_id=1, space_id=1, created_by_id=1, run_id=1, type_id=None, validated_by_id=None, composite_id=None, created_at=2025-11-11 13:42:32 UTC, is_locked=False)

# see all versions of an artifact
artifact$versions$to_dataframe()
#>                    uid                         key description   suffix    kind
#> 2 qoTS8tT6CYlGBynH0001 my_datasets/rnaseq1.parquet        <NA> .parquet dataset
#> 1 qoTS8tT6CYlGBynH0000 my_datasets/rnaseq1.parquet        <NA> .parquet dataset
#>       otype size                   hash n_files n_observations version
#> 2 DataFrame 9401 ebsyI2UUcC-leVTnot_2vg    <NA>              3    <NA>
#> 1 DataFrame 9401 K2fp8FbA1YbQxsOrfXX_ig    <NA>              3    <NA>
#>   is_latest is_locked          created_at branch_id space_id storage_id run_id
#> 2      TRUE     FALSE 2025-11-11 13:43:38         1        1          1      1
#> 1     FALSE     FALSE 2025-11-11 13:42:10         1        1          1      1
#>   schema_id created_by_id
#> 2         1             1
#> 1       NaN             1
```
...
#> → queried for all categorical features with dtype Record and non-categorical features: (6) ['temperature', 'experiment', 'perturbation', 'donor', 'concentration', 'treatment_time_h']
#>                    uid                         key temperature    experiment
#> 2 qoTS8tT6CYlGBynH0001 my_datasets/rnaseq1.parquet         NaN          <NA>
#> 1 qoTS8tT6CYlGBynH0000 my_datasets/rnaseq1.parquet        21.6 My experiment
#>                    perturbation
#> 2 <environment: 0x5628df103870>
#> 1                           NaN
ln$Artifact
#> Artifact
#>   Simple fields
...
#> id                                                                            
#> 2   qoTS8tT6CYlGBynH0001  my_datasets/rnaseq1.parquet        None  .parquet   
#> 1   qoTS8tT6CYlGBynH0000  my_datasets/rnaseq1.parquet        None  .parquet   
#> 
#>        kind      otype  size                    hash n_files  n_observations  \
#> id                                                                             
#> 2   dataset  DataFrame  9401  ebsyI2UUcC-leVTnot_2vg    None               3   
#> 1   dataset  DataFrame  9401  K2fp8FbA1YbQxsOrfXX_ig    None               3   
#> 
#>    version  is_latest  is_locked                       created_at  branch_id  \
#> id                                                                             
#> 2     None       True      False 2025-11-11 13:43:38.293000+00:00          1   
#> 1     None      False      False 2025-11-11 13:42:10.119000+00:00          1   
#> 
...
#>              uid                 name  \
#> id                                      
#> 9   JKkC1UYWfaYf     treatment_time_h   
#> 8   V5YYeea53oP1        concentration   
#> 7   QIug0EoY4Ynd                donor   
#> 6   GlrpUZ9aL3rd            assay_oid   
#> 5   iUJuubIKft7P  cell_type_by_expert   
#> 4   65N4UieHeh1h   cell_type_by_model   
#> 3   Rbcb4J2FKaVh         perturbation   
#> 
...
#> id                                                                        
#> 9  2025-11-11 13:42:32.466000+00:00          1         1              1   
#> 8  2025-11-11 13:42:32.324000+00:00          1         1              1   
#> 7  2025-11-11 13:42:32.193000+00:00          1         1              1   
#> 6  2025-11-11 13:42:31.908000+00:00          1         1              1   
#> 5  2025-11-11 13:42:31.680000+00:00          1         1              1   
#> 4  2025-11-11 13:42:31.429000+00:00          1         1              1   
#> 3  2025-11-11 13:42:31.182000+00:00          1         1              1   
#> 
#>     run_id type_id  
#> id                  
#> 9        1    None  
...
#> id                                                                              
#> 1    21.6  XftFE5byhwPHY-11WjfNAw      False 2025-11-11 13:42:30.311000+00:00   
#> 
...
#> id                                                                        
#> 1   o2cFT8NrP7YRj6un  None 2025-11-11 13:42:08.974748+00:00        None   
#> 
...
#> id                                                                       
#> 1  2025-11-11 13:42:08.975000+00:00          1         1             1   
#> 
#>    report_id _logfile_id environment_id  created_by_id initiated_by_run_id  
#> id                                                                          
...
#> id                                                                        
#> 2   swImhJjauW502ZUO  None        None  7    False  Feature  None  None   
#> 1   0000000000000000  None        None -1    False  Feature  None  None   
#> 
#>                       hash  minimal_set  ordered_set  maximal_set  slot  \
#> id                                                                        
#> 2   DaLoZq9AX9FiQv2UfB9mBQ         True        False        False  None   
#> 1   kMi7B_N88uu-YnbTLDU-DA         True        False        False  None   
#> 
#>     is_locked                       created_at  branch_id  space_id  \
#> id                                                                    
#> 2       False 2025-11-11 13:43:38.315000+00:00          1         1   
#> 1       False 2025-11-11 13:42:32.695000+00:00          1         1   
#> 
...
#> id                                                                          
#> 1   Shctdo0tW35u  /tmp/Rtmph3Qp5L/laminr-intro-20251111134123        None   
#> 
#>      type region  instance_uid  is_locked                       created_at  \
#> id                                                                           
#> 1   local   None  3YGOf8cb3mAM      False 2025-11-11 13:42:00.447000+00:00   
#> 
...
#> id                                                                         
#> 1   7R56qnkCRR2d0000  introduction.Rmd        None  notebook        None   
#> 
#>     hash reference reference_type version  is_latest  is_locked  \
#> id                                                                
#> 1   None      None           None    None       True      False   
#> 
#>                          created_at  branch_id  space_id  created_by_id  \
#> id                                                                        
#> 1  2025-11-11 13:42:08.971000+00:00          1         1              1   
#> 
#>    _template_id  
#> id               
#> 1          None  
...
#> id                                                                          
#> 3   OCKPffrV           IFNG    False        None      None           None   
#> 2   vaBCnDbJ           DMSO    False        None      None           None   
#> 1   eqsqTpj2  My experiment    False        None      None           None   
#> 
#>     is_locked                       created_at  branch_id  space_id  \
#> id                                                                    
#> 3       False 2025-11-11 13:42:30.958000+00:00          1         1   
#> 2       False 2025-11-11 13:42:30.690000+00:00          1         1   
#> 1       False 2025-11-11 13:42:12.336000+00:00          1         1   
#> 
...
#>                          created_at  branch_id  space_id  created_by_id  \
#> id                                                                        
#> 17 2025-11-11 13:42:34.616000+00:00          1         1              1   
#> 16 2025-11-11 13:42:34.616000+00:00          1         1              1   
#> 15 2025-11-11 13:42:34.283000+00:00          1         1              1   
#> 14 2025-11-11 13:42:33.920000+00:00          1         1              1   
#> 13 2025-11-11 13:42:33.577000+00:00          1         1              1   
#> 12 2025-11-11 13:42:29.697000+00:00          1         1              1   
#> 11 2025-11-11 13:42:29.697000+00:00          1         1              1   
#> 
#>     run_id  source_id  
#> id                     
#> 17       1         16  
...
#> 
#>                 instrument measurement  is_locked  \
#> id                                                  
#> 6   single cell sequencing        None      False   
#> 5       assay by sequencer        None      False   
#> 4                     None        None      False   
#> 3                     None        None      False   
#> 2                     None        None      False   
#> 1   single cell sequencing        None      False   
#> 
#>                          created_at  branch_id  space_id  created_by_id  \
#> id                                                                        
#> 6  2025-11-11 13:43:37.432000+00:00          1         1              1   
#> 5  2025-11-11 13:43:37.432000+00:00          1         1              1   
#> 4  2025-11-11 13:43:37.432000+00:00          1         1              1   
#> 3  2025-11-11 13:43:37.432000+00:00          1         1              1   
#> 2  2025-11-11 13:43:37.432000+00:00          1         1              1   
#> 1  2025-11-11 13:43:37.039000+00:00          1         1              1   
#> 
#>     run_id  source_id  
#> id                     
#> 6        1         21  
...
#> id                                                                   
#> 33  5JnVODh4                  BioSample      all       ncbi  False   
#> 32  MJRqduf9           bionty.Ethnicity    human  hancestro  False   
#> 31  10va5JSt  bionty.DevelopmentalStage    mouse     mmusdv  False   
#> 30  1GbFkOdz  bionty.DevelopmentalStage    human     hsapdv  False   
#> 29  1atB0WnU                       Drug      all      chebi  False   
#> 28  ugaIoIlj                       Drug      all       dron  False   
#> 27  3rm9aOzL                BFXPipeline      all      lamin  False   
#> 
#>     currently_used                               description  \
#> id                                                             
#> 33            True                 NCBI BioSample attributes   
#> 32            True                   Human Ancestry Ontology   
#> 31            True                Mouse Developmental Stages   
#> 30            True                Human Developmental Stages   
#> 29           False  Chemical Entities of Biological Interest   
#> 28            True                             Drug Ontology   
#> 27            True                   Bioinformatics Pipeline   
#> 
#>                                                   url   md5  \
#> id                                                            
#> 33  s3://bionty-assets/df_all__ncbi__2023-09__BioS...  None   
#> 32  http://purl.obolibrary.org/obo/hancestro/relea...  None   
#> 31  https://github.com/obophenotype/developmental-...  None   
#> 30  https://github.com/obophenotype/developmental-...  None   
#> 29  s3://bionty-assets/df_all__chebi__2024-07-27__...  None   
#> 28  http://purl.obolibrary.org/obo/dron/releases/2...  None   
#> 27  s3://bionty-assets/df_all__lamin__1.0.0__BFXpi...  None   
#> 
#>                                        source_website     version  is_locked  \
#> id                                                                             
#> 33  https://www.ncbi.nlm.nih.gov/biosample/docs/at...     2023-09      False   
#> 32               https://github.com/EBISPOT/hancestro         3.0      False   
#> 31  https://github.com/obophenotype/developmental-...  2024-05-28      False   
#> 30  https://github.com/obophenotype/developmental-...  2024-05-28      False   
#> 29                       https://www.ebi.ac.uk/chebi/  2024-07-27      False   
#> 28  https://bioportal.bioontology.org/ontologies/DRON  2024-08-05      False   
#> 27                                   https://lamin.ai       1.0.0      False   
#> 
#>                          created_at  branch_id  space_id  created_by_id  \
#> id                                                                        
#> 33 2025-11-11 13:42:00.492000+00:00          1         1              1   
#> 32 2025-11-11 13:42:00.492000+00:00          1         1              1   
#> 31 2025-11-11 13:42:00.492000+00:00          1         1              1   
#> 30 2025-11-11 13:42:00.492000+00:00          1         1              1   
#> 29 2025-11-11 13:42:00.492000+00:00          1         1              1   
#> 28 2025-11-11 13:42:00.492000+00:00          1         1              1   
#> 27 2025-11-11 13:42:00.492000+00:00          1         1              1   
#> 
...
#>  [6] source_code    hash           reference      reference_type version       
#> [11] is_latest      is_locked      created_at     branch_id      space_id      
#> [16] created_by_id  _template_id  
#> <0 rows> (or 0-length row.names)
...
#> ... synchronizing df_human__ensembl__release-112__Gene.parquet:  0.0%... synchronizing df_human__ensembl__release-112__Gene.parquet:  0.7%... synchronizing df_human__ensembl__release-112__Gene.parquet:  3.2%... synchronizing df_human__ensembl__release-112__Gene.parquet:  4.1%... synchronizing df_human__ensembl__release-112__Gene.parquet:  6.7%... synchronizing df_human__ensembl__release-112__Gene.parquet:  9.3%... synchronizing df_human__ensembl__release-112__Gene.parquet: 11.8%... synchronizing df_human__ensembl__release-112__Gene.parquet: 14.4%... synchronizing df_human__ensembl__release-112__Gene.parquet: 16.9%... synchronizing df_human__ensembl__release-112__Gene.parquet: 19.5%... synchronizing df_human__ensembl__release-112__Gene.parquet: 22.1%... synchronizing df_human__ensembl__release-112__Gene.parquet: 24.6%... synchronizing df_human__ensembl__release-112__Gene.parquet: 27.2%... synchronizing df_human__ensembl__release-112__Gene.parquet: 29.7%... synchronizing df_human__ensembl__release-112__Gene.parquet: 32.3%... synchronizing df_human__ensembl__release-112__Gene.parquet: 34.8%... synchronizing df_human__ensembl__release-112__Gene.parquet: 37.4%... synchronizing df_human__ensembl__release-112__Gene.parquet: 40.0%... synchronizing df_human__ensembl__release-112__Gene.parquet: 42.5%... synchronizing df_human__ensembl__release-112__Gene.parquet: 45.0%... synchronizing df_human__ensembl__release-112__Gene.parquet: 47.6%... synchronizing df_human__ensembl__release-112__Gene.parquet: 50.2%... synchronizing df_human__ensembl__release-112__Gene.parquet: 52.7%... synchronizing df_human__ensembl__release-112__Gene.parquet: 55.3%... synchronizing df_human__ensembl__release-112__Gene.parquet: 57.8%... synchronizing df_human__ensembl__release-112__Gene.parquet: 60.4%... synchronizing df_human__ensembl__release-112__Gene.parquet: 63.0%... synchronizing df_human__ensembl__release-112__Gene.parquet: 65.5%... synchronizing df_human__ensembl__release-112__Gene.parquet: 68.1%... synchronizing df_human__ensembl__release-112__Gene.parquet: 70.6%... synchronizing df_human__ensembl__release-112__Gene.parquet: 73.2%... synchronizing df_human__ensembl__release-112__Gene.parquet: 75.7%... synchronizing df_human__ensembl__release-112__Gene.parquet: 78.3%... synchronizing df_human__ensembl__release-112__Gene.parquet: 80.9%... synchronizing df_human__ensembl__release-112__Gene.parquet: 83.4%... synchronizing df_human__ensembl__release-112__Gene.parquet: 85.9%... synchronizing df_human__ensembl__release-112__Gene.parquet: 88.5%... synchronizing df_human__ensembl__release-112__Gene.parquet: 91.1%... synchronizing df_human__ensembl__release-112__Gene.parquet: 93.6%... synchronizing df_human__ensembl__release-112__Gene.parquet: 96.2%... synchronizing df_human__ensembl__release-112__Gene.parquet: 96.8%... synchronizing df_human__ensembl__release-112__Gene.parquet: 99.3%... synchronizing df_human__ensembl__release-112__Gene.parquet: 100.0%
#> → returning schema with same hash: Schema(uid='swImhJjauW502ZUO', name=None, description=None, n=7, is_type=False, itype='Feature', otype=None, dtype=None, hash='DaLoZq9AX9FiQv2UfB9mBQ', minimal_set=True, ordered_set=False, maximal_set=False, slot=None, branch_id=1, space_id=1, created_by_id=1, run_id=1, type_id=None, validated_by_id=None, composite_id=None, created_at=2025-11-11 13:43:38 UTC, is_locked=False)
artifact$describe()
#> Artifact: my_datasets/my_rnaseq1.h5ad (0000)
#> ├── uid: CCeumoWbblxbJfIv0000            run: o2cFT8N (introduction.Rmd)
#> │   kind: dataset                        otype: AnnData                 
#> │   hash: m2P4vKb8_FC7kjyyjXh0Xg         size: 29.5 KB                  
#> │   branch: main                         space: all                     
#> │   created_at: 2025-11-11 13:45:29 UTC  created_by: testuser1          
#> │   n_observations: 3                                                   
#> ├── storage/path: 
#> │   /tmp/Rtmph3Qp5L/laminr-intro-20251111134123/.lamindb/CCeumoWbblxbJfIv0000.h5
#> │   ad
#> ├── Dataset features
#> │   ├── obs (7)                                                                 
#> │   │   assay_oid           bionty.ExperimentalFa…  EFO:0008913                 
...
#>                    uid                         key description suffix    kind
#> 4 CCeumoWbblxbJfIv0000 my_datasets/my_rnaseq1.h5ad        <NA>  .h5ad dataset
...
#> 4     FALSE 2025-11-11 13:45:29         1        1          1      1         4
#>   created_by_id
#> 4             1
```
...
#> └── uid: siWoHWAdLvjndSTu0000            run: o2cFT8N (introduction.Rmd)
#>     branch: main                         space: all                     
#>     created_at: 2025-11-11 13:45:33 UTC  created_by: testuser1
...
#> <ArtifactBasicQuerySet [Artifact(uid='CCeumoWbblxbJfIv0000', version=None, is_latest=True, key='my_datasets/my_rnaseq1.h5ad', description=None, suffix='.h5ad', kind='dataset', otype='AnnData', size=30240, hash='m2P4vKb8_FC7kjyyjXh0Xg', n_files=None, n_observations=3, branch_id=1, space_id=1, storage_id=1, run_id=1, schema_id=4, created_by_id=1, created_at=2025-11-11 13:45:29 UTC, is_locked=False), Artifact(uid='ncuIEfK3Igo4pBx40000', version=None, is_latest=True, key='my_datasets/my_rnaseq2.h5ad', description=None, suffix='.h5ad', kind='dataset', otype='AnnData', size=23712, hash='vw0CqippRMuSj8iwUbojpQ', n_files=None, n_observations=3, branch_id=1, space_id=1, storage_id=1, run_id=1, schema_id=4, created_by_id=1, created_at=2025-11-11 13:45:32 UTC, is_locked=False)]>

# or look at a DataFrame listing the artifacts
collection$artifacts$to_dataframe()
#>                    uid                         key description suffix    kind
#> 5 ncuIEfK3Igo4pBx40000 my_datasets/my_rnaseq2.h5ad        <NA>  .h5ad dataset
#> 4 CCeumoWbblxbJfIv0000 my_datasets/my_rnaseq1.h5ad        <NA>  .h5ad dataset
#>     otype  size                   hash n_files n_observations version is_latest
#> 5 AnnData 23712 vw0CqippRMuSj8iwUbojpQ    <NA>              3    <NA>      TRUE
#> 4 AnnData 30240 m2P4vKb8_FC7kjyyjXh0Xg    <NA>              3    <NA>      TRUE
#>   is_locked          created_at branch_id space_id storage_id run_id schema_id
#> 5     FALSE 2025-11-11 13:45:32         1        1          1      1         4
#> 4     FALSE 2025-11-11 13:45:29         1        1          1      1         4
#>   created_by_id
#> 5             1
#> 4             1
...
#> → finished Run('o2cFT8NrP7YRj6un') after 3m at 2025-11-11 13:45:33 UTC
```
