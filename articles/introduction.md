...
ln$track()
#> → created Transform('jJALL3zdpUsw0000', key='introduction.Rmd'), started new Run('01dPBlqYkFSge7kE') at 2026-08-03 16:48:09 UTC
#> • tip: to identify the notebook across renames, pass the uid: ln$track("jJALL3zdpUsw")

ln$Transform$to_dataframe()
#>                uid              key description     kind source_code hash
#> 1 jJALL3zdpUsw0000 introduction.Rmd        <NA> notebook        <NA> <NA>
#>   reference reference_type version_tag is_latest is_locked          created_at
#> 1      <NA>           <NA>        <NA>      TRUE     FALSE 2026-08-03 16:48:09
...
#> 1 01dPBlqYkFSge7kE <NA>        <NA>       <NA> 2026-08-03 16:48:09        <NA>
...
#> 1 2026-08-03 16:48:09         1             1        1            1      <NA>
...
#> ├── uid: mOwp0XpwzvW5FyTa0000            run: 01dPBlq (introduction.Rmd)
#> │   kind: dataset                        otype: DataFrame               
#> │   hash: AM0X6uK1BTRrogI4TrMQXQ         size: 9.3 KB                   
#> │   branch: main                         space: all                     
#> │   created_at: 2026-08-03 16:48:12 UTC  created_by: testuser1          
#> │   n_observations: 3                                                   
#> └── storage/path: 
#>     /tmp/RtmpHNIC9t/laminr-intro-20260803164754/.lamindb/mOwp0XpwzvW5FyTa0000.pa
#>     rquet
```
...
#> sample3                                  Chinese
artifact$cache()
#> [1] "/tmp/RtmpHNIC9t/laminr-intro-20260803164754/.lamindb/mOwp0XpwzvW5FyTa0000.parquet"
```
...
artifact$transform
#> Transform(uid='jJALL3zdpUsw0000', key='introduction.Rmd', description=None, kind='notebook', hash=None, reference=None, reference_type=None, environment=None, plan=None, branch_id=1, created_on_id=1, space_id=1, run_id=None, created_by_id=1, created_at=2026-08-03 16:48:09 UTC, is_locked=False, version_tag=None, is_latest=True)
artifact$run
#> Run(uid='01dPBlqYkFSge7kE', name=None, description=None, entrypoint=None, started_at=2026-08-03 16:48:09 UTC, finished_at=None, params=None, extra_data=None, reference=None, reference_type=None, cli_args=None, branch_id=1, created_on_id=1, space_id=1, transform_id=1, report_id=None, environment_id=None, plan_id=None, created_by_id=1, initiated_by_run_id=None, created_at=2026-08-03 16:48:09 UTC, is_locked=False)
...
#> 1 mOwp0XpwzvW5FyTa0000 my_datasets/rnaseq1.parquet        <NA> .parquet dataset
#>       otype size                   hash n_files n_observations extra_data
#> 1 DataFrame 9491 AM0X6uK1BTRrogI4TrMQXQ    <NA>              3       <NA>
#>   version_tag is_latest is_locked          created_at branch_id created_on_id
#> 1        <NA>      TRUE     FALSE 2026-08-03 16:48:12         1             1
...
#> Feature(uid='INd6n8wHGNP7', is_type=False, name='temperature', _dtype_str='float', unit=None, description=None, array_rank=0, array_size=0, array_shape=None, synonyms=None, default_value=None, nullable=True, coerce=None, branch_id=1, created_on_id=1, space_id=1, created_by_id=1, run_id=1, type_id=None, created_at=2026-08-03 16:48:33 UTC, is_locked=False)
ln$Feature(name = "experiment", dtype = ln$Record)$save()
#> Feature(uid='DVMLh6Ar3cQz', is_type=False, name='experiment', _dtype_str='cat[Record]', unit=None, description=None, array_rank=0, array_size=0, array_shape=None, synonyms=None, default_value=None, nullable=True, coerce=None, branch_id=1, created_on_id=1, space_id=1, created_by_id=1, run_id=1, type_id=None, created_at=2026-08-03 16:48:34 UTC, is_locked=False)
...
#> Record(uid='ql5rvd0APq48pxGh', is_type=False, name='DMSO', description=None, reference=None, reference_type=None, extra_data=None, branch_id=1, created_on_id=1, space_id=1, created_by_id=1, type_id=None, schema_id=None, run_id=1, created_at=2026-08-03 16:48:35 UTC, is_locked=False)
ln$Record(name = "IFNG")$save()
#> Record(uid='LndiaieVHDRrXGdp', is_type=False, name='IFNG', description=None, reference=None, reference_type=None, extra_data=None, branch_id=1, created_on_id=1, space_id=1, created_by_id=1, type_id=None, schema_id=None, run_id=1, created_at=2026-08-03 16:48:35 UTC, is_locked=False)

# define a few more valid features
ln$Feature(name = "perturbation", dtype = ln$Record)$save()
#> Feature(uid='47iPseB2t3C0', is_type=False, name='perturbation', _dtype_str='cat[Record]', unit=None, description=None, array_rank=0, array_size=0, array_shape=None, synonyms=None, default_value=None, nullable=True, coerce=None, branch_id=1, created_on_id=1, space_id=1, created_by_id=1, run_id=1, type_id=None, created_at=2026-08-03 16:48:35 UTC, is_locked=False)
ln$Feature(name = "cell_type_by_model", dtype = bt$CellType)$save()
#> Feature(uid='adGqxiOMUiMC', is_type=False, name='cell_type_by_model', _dtype_str='cat[bionty.CellType]', unit=None, description=None, array_rank=0, array_size=0, array_shape=None, synonyms=None, default_value=None, nullable=True, coerce=None, branch_id=1, created_on_id=1, space_id=1, created_by_id=1, run_id=1, type_id=None, created_at=2026-08-03 16:48:36 UTC, is_locked=False)
ln$Feature(name = "cell_type_by_expert", dtype = bt$CellType)$save()
#> Feature(uid='7TfXWsRO9z2m', is_type=False, name='cell_type_by_expert', _dtype_str='cat[bionty.CellType]', unit=None, description=None, array_rank=0, array_size=0, array_shape=None, synonyms=None, default_value=None, nullable=True, coerce=None, branch_id=1, created_on_id=1, space_id=1, created_by_id=1, run_id=1, type_id=None, created_at=2026-08-03 16:48:36 UTC, is_locked=False)
ln$Feature(name = "assay_oid", dtype = bt$ExperimentalFactor$ontology_id)$save()
#> Feature(uid='Pl7qr1cQ1nKZ', is_type=False, name='assay_oid', _dtype_str='cat[bionty.ExperimentalFactor.ontology_id]', unit=None, description=None, array_rank=0, array_size=0, array_shape=None, synonyms=None, default_value=None, nullable=True, coerce=None, branch_id=1, created_on_id=1, space_id=1, created_by_id=1, run_id=1, type_id=None, created_at=2026-08-03 16:48:36 UTC, is_locked=False)
ln$Feature(name = "donor", dtype = "str", nullable = TRUE)$save()
#> ! rather than passing a string 'str' to dtype, consider passing a Python object
#> Feature(uid='BrWIjFsViL20', is_type=False, name='donor', _dtype_str='str', unit=None, description=None, array_rank=0, array_size=0, array_shape=None, synonyms=None, default_value=None, nullable=True, coerce=None, branch_id=1, created_on_id=1, space_id=1, created_by_id=1, run_id=1, type_id=None, created_at=2026-08-03 16:48:36 UTC, is_locked=False)
ln$Feature(name = "concentration", dtype = "str")$save()
#> ! rather than passing a string 'str' to dtype, consider passing a Python object
#> Feature(uid='oQDC7Cw7UYKc', is_type=False, name='concentration', _dtype_str='str', unit=None, description=None, array_rank=0, array_size=0, array_shape=None, synonyms=None, default_value=None, nullable=True, coerce=None, branch_id=1, created_on_id=1, space_id=1, created_by_id=1, run_id=1, type_id=None, created_at=2026-08-03 16:48:36 UTC, is_locked=False)
ln$Feature(name = "treatment_time_h", dtype = "num", coerce_dtype = TRUE)$save()
#> Feature(uid='cWky1gDHiwjW', is_type=False, name='treatment_time_h', _dtype_str='num', unit=None, description=None, array_rank=0, array_size=0, array_shape=None, synonyms=None, default_value=None, nullable=True, coerce=True, branch_id=1, created_on_id=1, space_id=1, created_by_id=1, run_id=1, type_id=None, created_at=2026-08-03 16:48:36 UTC, is_locked=False)
...
#> → returning artifact with same hash: Artifact(uid='mOwp0XpwzvW5FyTa0000', key='my_datasets/rnaseq1.parquet', description=None, suffix='.parquet', kind='dataset', otype='DataFrame', size=9491, hash='AM0X6uK1BTRrogI4TrMQXQ', n_files=None, n_observations=3, extra_data=None, branch_id=1, created_on_id=1, space_id=1, storage_id=1, run_id=1, schema_id=None, created_by_id=1, created_at=2026-08-03 16:48:12 UTC, is_locked=False, version_tag=None, is_latest=True); to track this artifact as an input, use: ln.Artifact.get()
#> → loading artifact into memory for validation
#> ... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet:  0.0%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet:  0.9%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet:  4.5%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet:  5.7%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet:  9.3%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 10.5%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 14.1%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 16.3%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 19.9%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 23.5%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 23.9%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 27.5%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 31.1%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 31.6%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 35.2%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 38.8%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 40.1%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 43.7%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 47.3%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 47.8%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 51.5%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 55.1%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 55.5%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 59.1%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 62.7%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 63.2%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 66.8%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 70.4%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 71.8%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 75.4%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 79.0%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 79.4%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 83.1%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 86.7%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 87.1%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 90.7%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 94.3%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 95.7%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 99.3%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 100.0%
```
...
#> → creating new artifact version for key 'my_datasets/rnaseq1.parquet' in storage '/tmp/RtmpHNIC9t/laminr-intro-20260803164754'
#> → loading artifact into memory for validation

# see the annotations
artifact$describe()
#> Artifact: my_datasets/rnaseq1.parquet (0001)
#> ├── uid: mOwp0XpwzvW5FyTa0001            run: 01dPBlq (introduction.Rmd)
#> │   kind: dataset                        otype: DataFrame               
#> │   hash: vKG3onQDXOxzWwU8ZvF8Ag         size: 9.3 KB                   
#> │   branch: main                         space: all                     
#> │   created_at: 2026-08-03 16:49:59 UTC  created_by: testuser1          
#> │   n_observations: 3                    schema: 0000000                
#> ├── storage/path: 
#> │   /tmp/RtmpHNIC9t/laminr-intro-20260803164754/.lamindb/mOwp0XpwzvW5FyTa0001.pa
#> │   rquet
#> ├── Dataset features
#> │   └── columns (7)                                                             
...
artifact$schema
#> Schema(uid='0000000000000000', is_type=False, name=None, description=None, n_members=None, coerce=None, flexible=True, itype='Feature', otype=None, suffix=None, hash='kMi7B_N88uu-YnbTLDU-DA', minimal_set=True, ordered_set=False, maximal_set=False, branch_id=1, created_on_id=1, space_id=1, created_by_id=1, run_id=1, type_id=None, created_at=2026-08-03 16:48:37 UTC, is_locked=False)

# see all versions of an artifact
artifact$versions$to_dataframe()
#>                    uid                         key description   suffix    kind
#> 2 mOwp0XpwzvW5FyTa0001 my_datasets/rnaseq1.parquet        <NA> .parquet dataset
#> 1 mOwp0XpwzvW5FyTa0000 my_datasets/rnaseq1.parquet        <NA> .parquet dataset
#>       otype size                   hash n_files n_observations extra_data
#> 2 DataFrame 9491 vKG3onQDXOxzWwU8ZvF8Ag    <NA>              3       <NA>
#> 1 DataFrame 9491 AM0X6uK1BTRrogI4TrMQXQ    <NA>              3       <NA>
#>   version_tag is_latest is_locked          created_at branch_id created_on_id
#> 2        <NA>      TRUE     FALSE 2026-08-03 16:49:59         1             1
#> 1        <NA>     FALSE     FALSE 2026-08-03 16:48:12         1             1
#>   space_id storage_id run_id schema_id created_by_id
#> 2        1          1      1         1             1
#> 1        1          1      1       NaN             1
```
...
#> 2 mOwp0XpwzvW5FyTa0001 my_datasets/rnaseq1.parquet         NaN          <NA>
#> 1 mOwp0XpwzvW5FyTa0000 my_datasets/rnaseq1.parquet        21.6 My experiment
#>       perturbation   cell_type_by_model
#> 2 {'DMSO', 'IFNG'} {'B cell', 'T cell'}
#> 1              NaN                  NaN
#>                             cell_type_by_expert   assay_oid
#> 2 {'CD8-positive, alpha-beta T cell', 'B cell'} EFO:0008913
#> 1                                           NaN        <NA>
ln$Artifact
...
#> id                                                     ...                        
#> 2   mOwp0XpwzvW5FyTa0001  my_datasets/rnaseq1.parquet  ...       1.0             1
#> 1   mOwp0XpwzvW5FyTa0000  my_datasets/rnaseq1.parquet  ...       NaN             1
#> 
#> [2 rows x 22 columns]
#> Feature
#>              uid                 name  ... run_id type_id
#> id                                     ...               
#> 9   cWky1gDHiwjW     treatment_time_h  ...      1    None
#> 8   oQDC7Cw7UYKc        concentration  ...      1    None
#> 7   BrWIjFsViL20                donor  ...      1    None
#> 6   Pl7qr1cQ1nKZ            assay_oid  ...      1    None
#> 5   7TfXWsRO9z2m  cell_type_by_expert  ...      1    None
#> 4   adGqxiOMUiMC   cell_type_by_model  ...      1    None
#> 3   47iPseB2t3C0         perturbation  ...      1    None
#> 
#> [7 rows x 21 columns]
#> Record
#>                  uid           name description  ... type_id schema_id run_id
#> id                                               ...                         
#> 3   LndiaieVHDRrXGdp           IFNG        None  ...    None      None      1
#> 2   ql5rvd0APq48pxGh           DMSO        None  ...    None      None      1
#> 1   YZWa8U8TPGyhaK4U  My experiment        None  ...    None      None      1
#> 
#> [3 rows x 16 columns]
#> Run
#>                  uid  name  ... created_by_id initiated_by_run_id
#> id                          ...                                  
#> 1   01dPBlqYkFSge7kE  None  ...             1                None
#> 
#> [1 rows x 22 columns]
#> Schema
#>                  uid  name description  ...  created_by_id run_id  type_id
#> id                                      ...                               
#> 2   goqzKILyTrmjYvvj  None        None  ...              1      1     None
...
#> id                                      ...                     
#> 1   jJALL3zdpUsw0000  introduction.Rmd  ...   None             1
#> 
#> [1 rows x 19 columns]
#> ******************
#> * module: bionty *
...
#> [16] space_id       environment_id plan_id        run_id         created_by_id 
#> <0 rows> (or 0-length row.names)
...
#> 1 3uWpoGifTXzr /tmp/RtmpHNIC9t/laminr-intro-20260803164754        <NA> local
#>      region instance_uid is_locked          created_at branch_id created_on_id
#> 2 us-east-1 4XIuR0tvaiXM     FALSE 2026-08-03 16:50:02         1             1
#> 1      <NA> 1UIT3WnicmNV     FALSE 2026-08-03 16:48:07         1             1
...
#> ... synchronizing df_human__ensembl__release-114__Gene.parquet:  0.0%... synchronizing df_human__ensembl__release-114__Gene.parquet:  0.6%... synchronizing df_human__ensembl__release-114__Gene.parquet:  3.1%... synchronizing df_human__ensembl__release-114__Gene.parquet:  4.0%... synchronizing df_human__ensembl__release-114__Gene.parquet:  6.4%... synchronizing df_human__ensembl__release-114__Gene.parquet:  7.5%... synchronizing df_human__ensembl__release-114__Gene.parquet: 10.0%... synchronizing df_human__ensembl__release-114__Gene.parquet: 10.8%... synchronizing df_human__ensembl__release-114__Gene.parquet: 13.2%... synchronizing df_human__ensembl__release-114__Gene.parquet: 14.0%... synchronizing df_human__ensembl__release-114__Gene.parquet: 16.4%... synchronizing df_human__ensembl__release-114__Gene.parquet: 17.2%... synchronizing df_human__ensembl__release-114__Gene.parquet: 19.7%... synchronizing df_human__ensembl__release-114__Gene.parquet: 21.1%... synchronizing df_human__ensembl__release-114__Gene.parquet: 23.6%... synchronizing df_human__ensembl__release-114__Gene.parquet: 24.4%... synchronizing df_human__ensembl__release-114__Gene.parquet: 26.8%... synchronizing df_human__ensembl__release-114__Gene.parquet: 27.6%... synchronizing df_human__ensembl__release-114__Gene.parquet: 30.0%... synchronizing df_human__ensembl__release-114__Gene.parquet: 30.8%... synchronizing df_human__ensembl__release-114__Gene.parquet: 33.3%... synchronizing df_human__ensembl__release-114__Gene.parquet: 34.7%... synchronizing df_human__ensembl__release-114__Gene.parquet: 37.1%... synchronizing df_human__ensembl__release-114__Gene.parquet: 37.9%... synchronizing df_human__ensembl__release-114__Gene.parquet: 40.4%... synchronizing df_human__ensembl__release-114__Gene.parquet: 41.2%... synchronizing df_human__ensembl__release-114__Gene.parquet: 43.6%... synchronizing df_human__ensembl__release-114__Gene.parquet: 44.4%... synchronizing df_human__ensembl__release-114__Gene.parquet: 46.8%... synchronizing df_human__ensembl__release-114__Gene.parquet: 48.3%... synchronizing df_human__ensembl__release-114__Gene.parquet: 50.7%... synchronizing df_human__ensembl__release-114__Gene.parquet: 51.5%... synchronizing df_human__ensembl__release-114__Gene.parquet: 54.0%... synchronizing df_human__ensembl__release-114__Gene.parquet: 54.8%... synchronizing df_human__ensembl__release-114__Gene.parquet: 57.2%... synchronizing df_human__ensembl__release-114__Gene.parquet: 58.0%... synchronizing df_human__ensembl__release-114__Gene.parquet: 60.4%... synchronizing df_human__ensembl__release-114__Gene.parquet: 61.2%... synchronizing df_human__ensembl__release-114__Gene.parquet: 63.7%... synchronizing df_human__ensembl__release-114__Gene.parquet: 65.1%... synchronizing df_human__ensembl__release-114__Gene.parquet: 67.5%... synchronizing df_human__ensembl__release-114__Gene.parquet: 68.3%... synchronizing df_human__ensembl__release-114__Gene.parquet: 70.8%... synchronizing df_human__ensembl__release-114__Gene.parquet: 71.6%... synchronizing df_human__ensembl__release-114__Gene.parquet: 74.0%... synchronizing df_human__ensembl__release-114__Gene.parquet: 75.4%... synchronizing df_human__ensembl__release-114__Gene.parquet: 77.9%... synchronizing df_human__ensembl__release-114__Gene.parquet: 78.7%... synchronizing df_human__ensembl__release-114__Gene.parquet: 81.1%... synchronizing df_human__ensembl__release-114__Gene.parquet: 81.9%... synchronizing df_human__ensembl__release-114__Gene.parquet: 84.4%... synchronizing df_human__ensembl__release-114__Gene.parquet: 85.2%... synchronizing df_human__ensembl__release-114__Gene.parquet: 87.6%... synchronizing df_human__ensembl__release-114__Gene.parquet: 89.0%... synchronizing df_human__ensembl__release-114__Gene.parquet: 91.5%... synchronizing df_human__ensembl__release-114__Gene.parquet: 92.3%... synchronizing df_human__ensembl__release-114__Gene.parquet: 94.7%... synchronizing df_human__ensembl__release-114__Gene.parquet: 95.5%... synchronizing df_human__ensembl__release-114__Gene.parquet: 97.9%... synchronizing df_human__ensembl__release-114__Gene.parquet: 98.7%... synchronizing df_human__ensembl__release-114__Gene.parquet: 100.0%
#> → returning schema with same hash: Schema(uid='goqzKILyTrmjYvvj', is_type=False, name=None, description=None, n_members=7, coerce=None, flexible=False, itype='Feature', otype=None, suffix=None, hash='lRHKs9VTHempGG_Aj4Z9RA', minimal_set=True, ordered_set=False, maximal_set=False, branch_id=1, created_on_id=1, space_id=1, created_by_id=1, run_id=1, type_id=None, created_at=2026-08-03 16:49:59 UTC, is_locked=False)
artifact$describe()
#> Artifact: my_datasets/my_rnaseq1.h5ad (0000)
#> ├── uid: IoaPB4qSKqZ5luBW0000            run: 01dPBlq (introduction.Rmd)
#> │   kind: dataset                        otype: AnnData                 
#> │   hash: 7I70-FPesYS8iFMNHwuIHQ         size: 29.6 KB                  
#> │   branch: main                         space: all                     
#> │   created_at: 2026-08-03 16:52:23 UTC  created_by: testuser1          
#> │   n_observations: 3                    schema: 63huDIj                
#> ├── storage/path: 
#> │   /tmp/RtmpHNIC9t/laminr-intro-20260803164754/.lamindb/IoaPB4qSKqZ5luBW0000.h5
#> │   ad
#> ├── Dataset features
#> │   ├── obs (7)                                                                 
#> │   │   assay_oid           bionty.ExperimentalFac…  EFO:0008913                
...
#>                    uid                         key description suffix    kind
#> 4 IoaPB4qSKqZ5luBW0000 my_datasets/my_rnaseq1.h5ad        <NA>  .h5ad dataset
#>     otype  size                   hash n_files n_observations extra_data
#> 4 AnnData 30280 7I70-FPesYS8iFMNHwuIHQ    <NA>              3       <NA>
#>   version_tag is_latest is_locked          created_at branch_id created_on_id
#> 4        <NA>      TRUE     FALSE 2026-08-03 16:52:23         1             1
#>   space_id storage_id run_id schema_id created_by_id
#> 4        1          1      1         4             1
```
...
#> └── uid: 0X9KdFVCt8OLDJVC0000            run: 01dPBlq (introduction.Rmd)
#>     branch: main                         space: all                     
#>     created_at: 2026-08-03 16:52:26 UTC  created_by: testuser1
...
#> <ArtifactBasicQuerySet [Artifact(uid='IoaPB4qSKqZ5luBW0000', key='my_datasets/my_rnaseq1.h5ad', description=None, suffix='.h5ad', kind='dataset', otype='AnnData', size=30280, hash='7I70-FPesYS8iFMNHwuIHQ', n_files=None, n_observations=3, extra_data=None, branch_id=1, created_on_id=1, space_id=1, storage_id=1, run_id=1, schema_id=4, created_by_id=1, created_at=2026-08-03 16:52:23 UTC, is_locked=False, version_tag=None, is_latest=True), Artifact(uid='RjP4elEDzXgvQHRg0000', key='my_datasets/my_rnaseq2.h5ad', description=None, suffix='.h5ad', kind='dataset', otype='AnnData', size=23616, hash='m2IP7F8nEMYbUs58TCQz6w', n_files=None, n_observations=3, extra_data=None, branch_id=1, created_on_id=1, space_id=1, storage_id=1, run_id=1, schema_id=4, created_by_id=1, created_at=2026-08-03 16:52:26 UTC, is_locked=False, version_tag=None, is_latest=True)]>

# or look at a DataFrame listing the artifacts
collection$artifacts$to_dataframe()
#>                    uid                         key description suffix    kind
#> 5 RjP4elEDzXgvQHRg0000 my_datasets/my_rnaseq2.h5ad        <NA>  .h5ad dataset
#> 4 IoaPB4qSKqZ5luBW0000 my_datasets/my_rnaseq1.h5ad        <NA>  .h5ad dataset
#>     otype  size                   hash n_files n_observations extra_data
#> 5 AnnData 23616 m2IP7F8nEMYbUs58TCQz6w    <NA>              3       <NA>
#> 4 AnnData 30280 7I70-FPesYS8iFMNHwuIHQ    <NA>              3       <NA>
#>   version_tag is_latest is_locked          created_at branch_id created_on_id
#> 5        <NA>      TRUE     FALSE 2026-08-03 16:52:26         1             1
#> 4        <NA>      TRUE     FALSE 2026-08-03 16:52:23         1             1
#>   space_id storage_id run_id schema_id created_by_id
#> 5        1          1      1         4             1
#> 4        1          1      1         4             1
...
#> → finished Run('01dPBlqYkFSge7kE') after 4m at 2026-08-03 16:52:27 UTC
```
