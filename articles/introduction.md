...
#> → connected lamindb: testuser1/laminr-intro-20260224135036
#> ℹ Requiring bionty
ln$track()
#> → created Transform('NoqVgG1IUvWC0000', key='introduction.Rmd'), started new Run('XdTGnlto2fzm1z9U') at 2026-02-24 13:50:54 UTC
#> • recommendation: to identify the notebook across renames, pass the uid: ln$track("NoqVgG1IUvWC")

ln$Transform$to_dataframe()
#>                uid              key description     kind source_code hash
#> 1 NoqVgG1IUvWC0000 introduction.Rmd        <NA> notebook        <NA> <NA>
#>   reference reference_type version_tag is_latest is_locked          created_at
#> 1      <NA>           <NA>        <NA>      TRUE     FALSE 2026-02-24 13:50:54
...
#> 1 XdTGnlto2fzm1z9U <NA>        <NA>       <NA> 2026-02-24 13:50:54        <NA>
#>   params reference reference_type cli_args is_locked          created_at
#> 1   <NA>      <NA>           <NA>     <NA>     FALSE 2026-02-24 13:50:54
...
#> ├── uid: qugmuX3TogSMmikw0000            run: XdTGnlt (introduction.Rmd)
#> │   kind: dataset                        otype: DataFrame               
#> │   hash: AZ3E6Lvmoku56ycTmqWZaw         size: 9.3 KB                   
#> │   branch: main                         space: all                     
#> │   created_at: 2026-02-24 13:50:56 UTC  created_by: testuser1          
#> │   n_observations: 3                                                   
#> └── storage/path: 
#>     /tmp/RtmpYxwuNy/laminr-intro-20260224135036/.lamindb/qugmuX3TogSMmikw0000.pa
#>     rquet
```
...
#> sample3                      Chinese
artifact$cache()
#> [1] "/tmp/RtmpYxwuNy/laminr-intro-20260224135036/.lamindb/qugmuX3TogSMmikw0000.parquet"
```
...
``` r
artifact$transform
#> Transform(uid='NoqVgG1IUvWC0000', version_tag=None, is_latest=True, key='introduction.Rmd', description=None, kind='notebook', hash=None, reference=None, reference_type=None, environment=None, plan=None, branch_id=1, created_on_id=1, space_id=1, created_by_id=1, created_at=2026-02-24 13:50:54 UTC, is_locked=False)
artifact$run
#> Run(uid='XdTGnlto2fzm1z9U', name=None, description=None, entrypoint=None, started_at=2026-02-24 13:50:54 UTC, finished_at=None, params=None, reference=None, reference_type=None, cli_args=None, branch_id=1, created_on_id=1, space_id=1, transform_id=1, report_id=None, environment_id=None, plan_id=None, created_by_id=1, initiated_by_run_id=None, created_at=2026-02-24 13:50:54 UTC, is_locked=False)
...
#> 1 qugmuX3TogSMmikw0000 my_datasets/rnaseq1.parquet        <NA> .parquet dataset
...
#> 1      TRUE     FALSE 2026-02-24 13:50:56         1             1        1
...
#> Feature(uid='c2bvafZzeYOu', is_type=False, name='temperature', _dtype_str='float', unit=None, description=None, array_rank=0, array_size=0, array_shape=None, synonyms=None, default_value=None, nullable=True, coerce=None, branch_id=1, created_on_id=1, space_id=1, created_by_id=1, run_id=1, type_id=None, created_at=2026-02-24 13:51:17 UTC, is_locked=False)
ln$Feature(name = "experiment", dtype = ln$Record)$save()
#> Feature(uid='L5tZJxILynI3', is_type=False, name='experiment', _dtype_str='cat[Record]', unit=None, description=None, array_rank=0, array_size=0, array_shape=None, synonyms=None, default_value=None, nullable=True, coerce=None, branch_id=1, created_on_id=1, space_id=1, created_by_id=1, run_id=1, type_id=None, created_at=2026-02-24 13:51:17 UTC, is_locked=False)
...
#> Record(uid='1yicebsf0NpFkBSC', is_type=False, name='DMSO', description=None, reference=None, reference_type=None, extra_data=None, branch_id=1, created_on_id=1, space_id=1, created_by_id=1, type_id=None, schema_id=None, run_id=1, created_at=2026-02-24 13:51:17 UTC, is_locked=False)
ln$Record(name = "IFNG")$save()
#> Record(uid='uFrjUkZdXmgqn2bA', is_type=False, name='IFNG', description=None, reference=None, reference_type=None, extra_data=None, branch_id=1, created_on_id=1, space_id=1, created_by_id=1, type_id=None, schema_id=None, run_id=1, created_at=2026-02-24 13:51:18 UTC, is_locked=False)

# define a few more valid features
ln$Feature(name = "perturbation", dtype = ln$Record)$save()
#> Feature(uid='eGHvJoHsOKxa', is_type=False, name='perturbation', _dtype_str='cat[Record]', unit=None, description=None, array_rank=0, array_size=0, array_shape=None, synonyms=None, default_value=None, nullable=True, coerce=None, branch_id=1, created_on_id=1, space_id=1, created_by_id=1, run_id=1, type_id=None, created_at=2026-02-24 13:51:18 UTC, is_locked=False)
ln$Feature(name = "cell_type_by_model", dtype = bt$CellType)$save()
#> Feature(uid='VjqdptjLxGoI', is_type=False, name='cell_type_by_model', _dtype_str='cat[bionty.CellType]', unit=None, description=None, array_rank=0, array_size=0, array_shape=None, synonyms=None, default_value=None, nullable=True, coerce=None, branch_id=1, created_on_id=1, space_id=1, created_by_id=1, run_id=1, type_id=None, created_at=2026-02-24 13:51:18 UTC, is_locked=False)
ln$Feature(name = "cell_type_by_expert", dtype = bt$CellType)$save()
#> Feature(uid='JMw6WyYAsBoB', is_type=False, name='cell_type_by_expert', _dtype_str='cat[bionty.CellType]', unit=None, description=None, array_rank=0, array_size=0, array_shape=None, synonyms=None, default_value=None, nullable=True, coerce=None, branch_id=1, created_on_id=1, space_id=1, created_by_id=1, run_id=1, type_id=None, created_at=2026-02-24 13:51:19 UTC, is_locked=False)
ln$Feature(name = "assay_oid", dtype = bt$ExperimentalFactor$ontology_id)$save()
#> Feature(uid='zlbVjNupSedl', is_type=False, name='assay_oid', _dtype_str='cat[bionty.ExperimentalFactor.ontology_id]', unit=None, description=None, array_rank=0, array_size=0, array_shape=None, synonyms=None, default_value=None, nullable=True, coerce=None, branch_id=1, created_on_id=1, space_id=1, created_by_id=1, run_id=1, type_id=None, created_at=2026-02-24 13:51:19 UTC, is_locked=False)
ln$Feature(name = "donor", dtype = "str", nullable = TRUE)$save()
#> ! rather than passing a string 'str' to dtype, consider passing a Python object
#> Feature(uid='bfQtfuHpLTME', is_type=False, name='donor', _dtype_str='str', unit=None, description=None, array_rank=0, array_size=0, array_shape=None, synonyms=None, default_value=None, nullable=True, coerce=None, branch_id=1, created_on_id=1, space_id=1, created_by_id=1, run_id=1, type_id=None, created_at=2026-02-24 13:51:19 UTC, is_locked=False)
ln$Feature(name = "concentration", dtype = "str")$save()
#> ! rather than passing a string 'str' to dtype, consider passing a Python object
#> Feature(uid='VEDkTa3NX4V1', is_type=False, name='concentration', _dtype_str='str', unit=None, description=None, array_rank=0, array_size=0, array_shape=None, synonyms=None, default_value=None, nullable=True, coerce=None, branch_id=1, created_on_id=1, space_id=1, created_by_id=1, run_id=1, type_id=None, created_at=2026-02-24 13:51:19 UTC, is_locked=False)
ln$Feature(name = "treatment_time_h", dtype = "num", coerce_dtype = TRUE)$save()
#> Feature(uid='Ie4lR1eb24mR', is_type=False, name='treatment_time_h', _dtype_str='num', unit=None, description=None, array_rank=0, array_size=0, array_shape=None, synonyms=None, default_value=None, nullable=True, coerce=True, branch_id=1, created_on_id=1, space_id=1, created_by_id=1, run_id=1, type_id=None, created_at=2026-02-24 13:51:19 UTC, is_locked=False)
...
#> ... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet:  0.0%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet:  0.9%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet:  4.5%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet:  5.7%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet:  9.3%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 12.9%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 16.5%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 20.1%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 21.0%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 24.6%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 28.2%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 31.8%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 35.3%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 38.9%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 42.6%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 46.2%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 49.8%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 53.4%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 57.0%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 60.6%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 64.1%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 67.7%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 71.3%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 74.9%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 78.5%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 82.1%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 85.7%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 89.3%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 92.9%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 96.5%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 100.0%
```
...
#> → writing the in-memory object into cache
#> → creating new artifact version for key 'my_datasets/rnaseq1.parquet' in storage '/tmp/RtmpYxwuNy/laminr-intro-20260224135036'
#> → loading artifact into memory for validation
#> ! 5 terms not validated in feature 'columns': 'ENSG00000153563', 'ENSG00000010610', 'ENSG00000170458', 'sample_note', 'donor_ethnicity'
#>     → fix typos, remove non-existent values, or save terms via: curator.cat.add_new_from('columns')
...
#> ├── uid: qugmuX3TogSMmikw0001            run: XdTGnlt (introduction.Rmd)
#> │   kind: dataset                        otype: DataFrame               
#> │   hash: AGGfjb429xRtcIEQjCLK9w         size: 9.3 KB                   
#> │   branch: main                         space: all                     
#> │   created_at: 2026-02-24 13:52:25 UTC  created_by: testuser1          
#> │   n_observations: 3                                                   
#> ├── storage/path: 
#> │   /tmp/RtmpYxwuNy/laminr-intro-20260224135036/.lamindb/qugmuX3TogSMmikw0001.pa
#> │   rquet
#> ├── Dataset features
#> │   └── columns (7)                                                             
...
#> 2 qugmuX3TogSMmikw0001 my_datasets/rnaseq1.parquet         NaN          <NA>
#> 1 qugmuX3TogSMmikw0000 my_datasets/rnaseq1.parquet        21.6 My experiment
#>                    perturbation
#> 2 <environment: 0x558ff6e93978>
#> 1                           NaN
ln$Artifact
...
#> id                                                     ...                        
#> 2   qugmuX3TogSMmikw0001  my_datasets/rnaseq1.parquet  ...       1.0             1
#> 1   qugmuX3TogSMmikw0000  my_datasets/rnaseq1.parquet  ...       NaN             1
#> 
#> [2 rows x 21 columns]
#> Feature
#>              uid                 name  ... run_id type_id
#> id                                     ...               
#> 9   Ie4lR1eb24mR     treatment_time_h  ...      1    None
#> 8   VEDkTa3NX4V1        concentration  ...      1    None
#> 7   bfQtfuHpLTME                donor  ...      1    None
#> 6   zlbVjNupSedl            assay_oid  ...      1    None
#> 5   JMw6WyYAsBoB  cell_type_by_expert  ...      1    None
#> 4   VjqdptjLxGoI   cell_type_by_model  ...      1    None
#> 3   eGHvJoHsOKxa         perturbation  ...      1    None
#> 
#> [7 rows x 21 columns]
#> JsonValue
...
#> id                                               ...                         
#> 3   uFrjUkZdXmgqn2bA           IFNG        None  ...    None      None      1
#> 2   1yicebsf0NpFkBSC           DMSO        None  ...    None      None      1
#> 1   Pd8RB7Y5JyGLI5dK  My experiment        None  ...    None      None      1
#> 
#> [3 rows x 16 columns]
#> Run
#>                  uid  name  ... created_by_id initiated_by_run_id
#> id                          ...                                  
#> 1   XdTGnlto2fzm1z9U  None  ...             1                None
#> 
#> [1 rows x 21 columns]
#> Schema
#>                  uid  name description  ...  created_by_id run_id  type_id
#> id                                      ...                               
#> 2   QvO9BwkUUpmFvL78  None        None  ...              1      1     None
...
#> id                                      ...                      
#> 1   NoqVgG1IUvWC0000  introduction.Rmd  ...    None             1
#> 
#> [1 rows x 18 columns]
#> ******************
#> * module: bionty *
...
#> 1 tPCxaI6usCTM /tmp/RtmpYxwuNy/laminr-intro-20260224135036        <NA> local
#>      region instance_uid is_locked          created_at branch_id created_on_id
#> 2 us-east-1 4XIuR0tvaiXM     FALSE 2026-02-24 13:52:32         1             1
#> 1      <NA> lzBAzBm1mKVB     FALSE 2026-02-24 13:50:46         1             1
...
#>                    uid                         key description suffix    kind
#> 4 e2ZHkXB9UAlKdWdX0000 my_datasets/my_rnaseq1.h5ad        <NA>  .h5ad dataset
#>     otype  size                   hash n_files n_observations version_tag
#> 4 AnnData 30240 m2P4vKb8_FC7kjyyjXh0Xg    <NA>              3        <NA>
#>   is_latest is_locked          created_at branch_id created_on_id space_id
#> 4      TRUE     FALSE 2026-02-24 13:54:21         1             1        1
#>   storage_id run_id schema_id created_by_id
#> 4          1      1         4             1
```
...
#> └── uid: u1BlJMc3TPrkElmc0000            run: XdTGnlt (introduction.Rmd)
#>     branch: main                         space: all                     
#>     created_at: 2026-02-24 13:54:25 UTC  created_by: testuser1
...
#> <ArtifactBasicQuerySet [Artifact(uid='e2ZHkXB9UAlKdWdX0000', version_tag=None, is_latest=True, key='my_datasets/my_rnaseq1.h5ad', description=None, suffix='.h5ad', kind='dataset', otype='AnnData', size=30240, hash='m2P4vKb8_FC7kjyyjXh0Xg', n_files=None, n_observations=3, branch_id=1, created_on_id=1, space_id=1, storage_id=1, run_id=1, schema_id=4, created_by_id=1, created_at=2026-02-24 13:54:21 UTC, is_locked=False), Artifact(uid='Dqi9Yzkwjf10ImWm0000', version_tag=None, is_latest=True, key='my_datasets/my_rnaseq2.h5ad', description=None, suffix='.h5ad', kind='dataset', otype='AnnData', size=23712, hash='vw0CqippRMuSj8iwUbojpQ', n_files=None, n_observations=3, branch_id=1, created_on_id=1, space_id=1, storage_id=1, run_id=1, schema_id=4, created_by_id=1, created_at=2026-02-24 13:54:24 UTC, is_locked=False)]>

# or look at a DataFrame listing the artifacts
collection$artifacts$to_dataframe()
#>                    uid                         key description suffix    kind
#> 5 Dqi9Yzkwjf10ImWm0000 my_datasets/my_rnaseq2.h5ad        <NA>  .h5ad dataset
#> 4 e2ZHkXB9UAlKdWdX0000 my_datasets/my_rnaseq1.h5ad        <NA>  .h5ad dataset
#>     otype  size                   hash n_files n_observations version_tag
#> 5 AnnData 23712 vw0CqippRMuSj8iwUbojpQ    <NA>              3        <NA>
#> 4 AnnData 30240 m2P4vKb8_FC7kjyyjXh0Xg    <NA>              3        <NA>
#>   is_latest is_locked          created_at branch_id created_on_id space_id
#> 5      TRUE     FALSE 2026-02-24 13:54:24         1             1        1
#> 4      TRUE     FALSE 2026-02-24 13:54:21         1             1        1
#>   storage_id run_id schema_id created_by_id
#> 5          1      1         4             1
#> 4          1      1         4             1
...
#> → finished Run('XdTGnlto2fzm1z9U') after 3m at 2026-02-24 13:54:26 UTC
```
