...
#> → connected lamindb: testuser1/laminr-intro-20251111135047
#> ℹ Requiring bionty
ln$track()
#> → created Transform('bdK2WEwzgMv80000', key='introduction.Rmd'), started new Run('2id3j2U1R5c8p3vI') at 2025-11-11 13:51:30 UTC
#> • recommendation: to identify the notebook across renames, pass the uid: ln$track("bdK2WEwzgMv8")

ln$Transform$to_dataframe()
#>                uid              key description     type source_code hash
#> 1 bdK2WEwzgMv80000 introduction.Rmd        <NA> notebook        <NA> <NA>
#>   reference reference_type version is_latest is_locked          created_at
#> 1      <NA>           <NA>    <NA>      TRUE     FALSE 2025-11-11 13:51:30
#>   branch_id space_id created_by_id _template_id
#> 1         1        1             1         <NA>
ln$Run$to_dataframe()
#>                uid name          started_at finished_at params reference
#> 1 2id3j2U1R5c8p3vI <NA> 2025-11-11 13:51:30        <NA>   <NA>      <NA>
#>   reference_type is_locked          created_at branch_id space_id transform_id
#> 1           <NA>     FALSE 2025-11-11 13:51:30         1        1            1
...
#> ├── uid: hOSX7rp3HidEwhDv0000            run: 2id3j2U (introduction.Rmd)
#> │   kind: dataset                        otype: DataFrame               
#> │   hash: K2fp8FbA1YbQxsOrfXX_ig         size: 9.2 KB                   
#> │   branch: main                         space: all                     
#> │   created_at: 2025-11-11 13:51:31 UTC  created_by: testuser1          
#> │   n_observations: 3                                                   
#> └── storage/path: 
#>     /tmp/Rtmp92na1c/laminr-intro-20251111135047/.lamindb/hOSX7rp3HidEwhDv0000.pa
#>     rquet
```
...
#> sample3                      Chinese
artifact$cache()
#> [1] "/tmp/Rtmp92na1c/laminr-intro-20251111135047/.lamindb/hOSX7rp3HidEwhDv0000.parquet"
```
...
``` r
artifact$transform
#> Transform(uid='bdK2WEwzgMv80000', version=None, is_latest=True, key='introduction.Rmd', description=None, type='notebook', hash=None, reference=None, reference_type=None, branch_id=1, space_id=1, created_by_id=1, created_at=2025-11-11 13:51:30 UTC, is_locked=False)
artifact$run
#> Run(uid='2id3j2U1R5c8p3vI', name=None, started_at=2025-11-11 13:51:30 UTC, finished_at=None, params=None, reference=None, reference_type=None, branch_id=1, space_id=1, transform_id=1, report_id=None, environment_id=None, created_by_id=1, initiated_by_run_id=None, created_at=2025-11-11 13:51:30 UTC, is_locked=False)
...
#> 1 hOSX7rp3HidEwhDv0000 my_datasets/rnaseq1.parquet        <NA> .parquet dataset
...
#> 1      TRUE     FALSE 2025-11-11 13:51:31         1        1          1      1
...
#> Feature(uid='2kpMXpbz2tCf', name='temperature', dtype='float', is_type=None, unit=None, description=None, array_rank=0, array_size=0, array_shape=None, proxy_dtype=None, synonyms=None, branch_id=1, space_id=1, created_by_id=1, run_id=1, type_id=None, created_at=2025-11-11 13:51:50 UTC, is_locked=False)
ln$Feature(name = "experiment", dtype = ln$ULabel)$save()
#> Feature(uid='s4YXzcqph8DL', name='experiment', dtype='cat[ULabel]', is_type=None, unit=None, description=None, array_rank=0, array_size=0, array_shape=None, proxy_dtype=None, synonyms=None, branch_id=1, space_id=1, created_by_id=1, run_id=1, type_id=None, created_at=2025-11-11 13:51:50 UTC, is_locked=False)
...
#> ULabel(uid='YJjVBNG3', name='DMSO', is_type=False, description=None, reference=None, reference_type=None, branch_id=1, space_id=1, created_by_id=1, run_id=1, type_id=None, created_at=2025-11-11 13:51:51 UTC, is_locked=False)
ln$ULabel(name = "IFNG")$save()
#> ULabel(uid='WD8mPwbX', name='IFNG', is_type=False, description=None, reference=None, reference_type=None, branch_id=1, space_id=1, created_by_id=1, run_id=1, type_id=None, created_at=2025-11-11 13:51:51 UTC, is_locked=False)

# define a few more valid features
ln$Feature(name = "perturbation", dtype = ln$ULabel)$save()
#> Feature(uid='sY9uYJuyM0kU', name='perturbation', dtype='cat[ULabel]', is_type=None, unit=None, description=None, array_rank=0, array_size=0, array_shape=None, proxy_dtype=None, synonyms=None, branch_id=1, space_id=1, created_by_id=1, run_id=1, type_id=None, created_at=2025-11-11 13:51:51 UTC, is_locked=False)
ln$Feature(name = "cell_type_by_model", dtype = bt$CellType)$save()
#> Feature(uid='G2NHJRpc2cqf', name='cell_type_by_model', dtype='cat[bionty.CellType]', is_type=None, unit=None, description=None, array_rank=0, array_size=0, array_shape=None, proxy_dtype=None, synonyms=None, branch_id=1, space_id=1, created_by_id=1, run_id=1, type_id=None, created_at=2025-11-11 13:51:51 UTC, is_locked=False)
ln$Feature(name = "cell_type_by_expert", dtype = bt$CellType)$save()
#> Feature(uid='HWPj9kjeRufz', name='cell_type_by_expert', dtype='cat[bionty.CellType]', is_type=None, unit=None, description=None, array_rank=0, array_size=0, array_shape=None, proxy_dtype=None, synonyms=None, branch_id=1, space_id=1, created_by_id=1, run_id=1, type_id=None, created_at=2025-11-11 13:51:51 UTC, is_locked=False)
ln$Feature(name = "assay_oid", dtype = bt$ExperimentalFactor$ontology_id)$save()
#> Feature(uid='JHuuW7YQwfYO', name='assay_oid', dtype='cat[bionty.ExperimentalFactor.ontology_id]', is_type=None, unit=None, description=None, array_rank=0, array_size=0, array_shape=None, proxy_dtype=None, synonyms=None, branch_id=1, space_id=1, created_by_id=1, run_id=1, type_id=None, created_at=2025-11-11 13:51:52 UTC, is_locked=False)
ln$Feature(name = "donor", dtype = "str", nullable = TRUE)$save()
#> Feature(uid='edsVeS42ug3X', name='donor', dtype='str', is_type=None, unit=None, description=None, array_rank=0, array_size=0, array_shape=None, proxy_dtype=None, synonyms=None, branch_id=1, space_id=1, created_by_id=1, run_id=1, type_id=None, created_at=2025-11-11 13:51:52 UTC, is_locked=False)
ln$Feature(name = "concentration", dtype = "str")$save()
#> Feature(uid='6fymOrwUXFaY', name='concentration', dtype='str', is_type=None, unit=None, description=None, array_rank=0, array_size=0, array_shape=None, proxy_dtype=None, synonyms=None, branch_id=1, space_id=1, created_by_id=1, run_id=1, type_id=None, created_at=2025-11-11 13:51:52 UTC, is_locked=False)
ln$Feature(name = "treatment_time_h", dtype = "num", coerce_dtype = TRUE)$save()
#> Feature(uid='cN4By0rNVz6r', name='treatment_time_h', dtype='num', is_type=None, unit=None, description=None, array_rank=0, array_size=0, array_shape=None, proxy_dtype=None, synonyms=None, branch_id=1, space_id=1, created_by_id=1, run_id=1, type_id=None, created_at=2025-11-11 13:51:52 UTC, is_locked=False)
...
#> → writing the in-memory object into cache
#> → creating new artifact version for key 'my_datasets/rnaseq1.parquet' in storage '/tmp/Rtmp92na1c/laminr-intro-20251111135047'
#> → loading artifact into memory for validation
#> ! 5 terms not validated in feature 'columns': 'ENSG00000153563', 'ENSG00000010610', 'ENSG00000170458', 'sample_note', 'donor_ethnicity'
#>     → fix typos, remove non-existent values, or save terms via: curator.cat.add_new_from('columns')
...
#> ├── uid: hOSX7rp3HidEwhDv0001            run: 2id3j2U (introduction.Rmd)
#> │   kind: dataset                        otype: DataFrame               
#> │   hash: ebsyI2UUcC-leVTnot_2vg         size: 9.2 KB                   
#> │   branch: main                         space: all                     
#> │   created_at: 2025-11-11 13:52:57 UTC  created_by: testuser1          
#> │   n_observations: 3                                                   
#> ├── storage/path: 
#> │   /tmp/Rtmp92na1c/laminr-intro-20251111135047/.lamindb/hOSX7rp3HidEwhDv0001.pa
#> │   rquet
#> ├── Dataset features
#> │   └── columns (7)                                                             
...
artifact$schema
#> Schema(uid='0000000000000000', name=None, description=None, is_type=False, itype='Feature', otype=None, dtype=None, hash='kMi7B_N88uu-YnbTLDU-DA', minimal_set=True, ordered_set=False, maximal_set=False, slot=None, branch_id=1, space_id=1, created_by_id=1, run_id=1, type_id=None, validated_by_id=None, composite_id=None, created_at=2025-11-11 13:51:52 UTC, is_locked=False)

# see all versions of an artifact
artifact$versions$to_dataframe()
#>                    uid                         key description   suffix    kind
#> 2 hOSX7rp3HidEwhDv0001 my_datasets/rnaseq1.parquet        <NA> .parquet dataset
#> 1 hOSX7rp3HidEwhDv0000 my_datasets/rnaseq1.parquet        <NA> .parquet dataset
#>       otype size                   hash n_files n_observations version
#> 2 DataFrame 9401 ebsyI2UUcC-leVTnot_2vg    <NA>              3    <NA>
#> 1 DataFrame 9401 K2fp8FbA1YbQxsOrfXX_ig    <NA>              3    <NA>
#>   is_latest is_locked          created_at branch_id space_id storage_id run_id
#> 2      TRUE     FALSE 2025-11-11 13:52:57         1        1          1      1
#> 1     FALSE     FALSE 2025-11-11 13:51:31         1        1          1      1
#>   schema_id created_by_id
#> 2         1             1
#> 1       NaN             1
```
...
#> 2 hOSX7rp3HidEwhDv0001 my_datasets/rnaseq1.parquet         NaN          <NA>
#> 1 hOSX7rp3HidEwhDv0000 my_datasets/rnaseq1.parquet        21.6 My experiment
#>                    perturbation
#> 2 <environment: 0x55befb86c058>
#> 1                           NaN
ln$Artifact
#> Artifact
#>   Simple fields
...
#> id                                                                            
#> 2   hOSX7rp3HidEwhDv0001  my_datasets/rnaseq1.parquet        None  .parquet   
#> 1   hOSX7rp3HidEwhDv0000  my_datasets/rnaseq1.parquet        None  .parquet   
#> 
...
#> id                                                                             
#> 2     None       True      False 2025-11-11 13:52:57.346000+00:00          1   
#> 1     None      False      False 2025-11-11 13:51:31.213000+00:00          1   
#> 
...
#>              uid                 name  \
#> id                                      
#> 9   cN4By0rNVz6r     treatment_time_h   
#> 8   6fymOrwUXFaY        concentration   
#> 7   edsVeS42ug3X                donor   
#> 6   JHuuW7YQwfYO            assay_oid   
#> 5   HWPj9kjeRufz  cell_type_by_expert   
#> 4   G2NHJRpc2cqf   cell_type_by_model   
#> 3   sY9uYJuyM0kU         perturbation   
#> 
...
#> id                                                                        
#> 9  2025-11-11 13:51:52.709000+00:00          1         1              1   
#> 8  2025-11-11 13:51:52.584000+00:00          1         1              1   
#> 7  2025-11-11 13:51:52.459000+00:00          1         1              1   
#> 6  2025-11-11 13:51:52.333000+00:00          1         1              1   
#> 5  2025-11-11 13:51:51.960000+00:00          1         1              1   
#> 4  2025-11-11 13:51:51.725000+00:00          1         1              1   
#> 3  2025-11-11 13:51:51.509000+00:00          1         1              1   
#> 
#>     run_id type_id  
#> id                  
#> 9        1    None  
...
#> id                                                                              
#> 1    21.6  XftFE5byhwPHY-11WjfNAw      False 2025-11-11 13:51:50.666000+00:00   
#> 
...
#> id                                                                        
#> 1   2id3j2U1R5c8p3vI  None 2025-11-11 13:51:30.096808+00:00        None   
#> 
...
#> id                                                                       
#> 1  2025-11-11 13:51:30.097000+00:00          1         1             1   
#> 
#>    report_id _logfile_id environment_id  created_by_id initiated_by_run_id  
#> id                                                                          
...
#> id                                                                        
#> 2   1AaR6MYize150yx2  None        None  7    False  Feature  None  None   
#> 1   0000000000000000  None        None -1    False  Feature  None  None   
#> 
#>                       hash  minimal_set  ordered_set  maximal_set  slot  \
#> id                                                                        
#> 2   RO8K-F06uyGZElLNFuqBUA         True        False        False  None   
#> 1   kMi7B_N88uu-YnbTLDU-DA         True        False        False  None   
#> 
#>     is_locked                       created_at  branch_id  space_id  \
#> id                                                                    
#> 2       False 2025-11-11 13:52:57.366000+00:00          1         1   
#> 1       False 2025-11-11 13:51:52.937000+00:00          1         1   
#> 
...
#> id                                                                          
#> 1   89BnAJjSnjsQ  /tmp/Rtmp92na1c/laminr-intro-20251111135047        None   
#> 
#>      type region  instance_uid  is_locked                       created_at  \
#> id                                                                           
#> 1   local   None  5QbxZyk1YgEN      False 2025-11-11 13:51:21.946000+00:00   
#> 
...
#> id                                                                         
#> 1   bdK2WEwzgMv80000  introduction.Rmd        None  notebook        None   
#> 
...
#>                          created_at  branch_id  space_id  created_by_id  \
#> id                                                                        
#> 1  2025-11-11 13:51:30.091000+00:00          1         1              1   
#> 
#>    _template_id  
#> id               
#> 1          None  
...
#> id                                                                          
#> 3   WD8mPwbX           IFNG    False        None      None           None   
#> 2   YJjVBNG3           DMSO    False        None      None           None   
#> 1   5bgf7LLJ  My experiment    False        None      None           None   
#> 
#>     is_locked                       created_at  branch_id  space_id  \
#> id                                                                    
#> 3       False 2025-11-11 13:51:51.124000+00:00          1         1   
#> 2       False 2025-11-11 13:51:51.021000+00:00          1         1   
#> 1       False 2025-11-11 13:51:33.287000+00:00          1         1   
#> 
...
#>                          created_at  branch_id  space_id  created_by_id  \
#> id                                                                        
#> 17 2025-11-11 13:51:54.012000+00:00          1         1              1   
#> 16 2025-11-11 13:51:54.012000+00:00          1         1              1   
#> 15 2025-11-11 13:51:53.863000+00:00          1         1              1   
#> 14 2025-11-11 13:51:53.697000+00:00          1         1              1   
#> 13 2025-11-11 13:51:53.547000+00:00          1         1              1   
#> 12 2025-11-11 13:51:50.088000+00:00          1         1              1   
#> 11 2025-11-11 13:51:50.088000+00:00          1         1              1   
#> 
#>     run_id  source_id  
#> id                     
#> 17       1         16  
...
#>                          created_at  branch_id  space_id  created_by_id  \
#> id                                                                        
#> 6  2025-11-11 13:52:56.480000+00:00          1         1              1   
#> 5  2025-11-11 13:52:56.480000+00:00          1         1              1   
#> 4  2025-11-11 13:52:56.480000+00:00          1         1              1   
#> 3  2025-11-11 13:52:56.480000+00:00          1         1              1   
#> 2  2025-11-11 13:52:56.480000+00:00          1         1              1   
#> 1  2025-11-11 13:52:56.234000+00:00          1         1              1   
#> 
#>     run_id  source_id  
#> id                     
#> 6        1         21  
...
#>                          created_at  branch_id  space_id  created_by_id  \
#> id                                                                        
#> 33 2025-11-11 13:51:21.990000+00:00          1         1              1   
#> 32 2025-11-11 13:51:21.990000+00:00          1         1              1   
#> 31 2025-11-11 13:51:21.990000+00:00          1         1              1   
#> 30 2025-11-11 13:51:21.990000+00:00          1         1              1   
#> 29 2025-11-11 13:51:21.990000+00:00          1         1              1   
#> 28 2025-11-11 13:51:21.990000+00:00          1         1              1   
#> 27 2025-11-11 13:51:21.990000+00:00          1         1              1   
#> 
...
#> 1 89BnAJjSnjsQ /tmp/Rtmp92na1c/laminr-intro-20251111135047        <NA> local
#>      region instance_uid is_locked          created_at branch_id space_id
#> 2 us-east-1 4XIuR0tvaiXM     FALSE 2025-11-11 13:53:01         1        1
#> 1      <NA> 5QbxZyk1YgEN     FALSE 2025-11-11 13:51:21         1        1
...
#> ... synchronizing df_human__ensembl__release-112__Gene.parquet:  0.0%... synchronizing df_human__ensembl__release-112__Gene.parquet:  0.7%... synchronizing df_human__ensembl__release-112__Gene.parquet:  3.2%... synchronizing df_human__ensembl__release-112__Gene.parquet:  4.1%... synchronizing df_human__ensembl__release-112__Gene.parquet:  6.7%... synchronizing df_human__ensembl__release-112__Gene.parquet:  9.3%... synchronizing df_human__ensembl__release-112__Gene.parquet: 11.8%... synchronizing df_human__ensembl__release-112__Gene.parquet: 14.4%... synchronizing df_human__ensembl__release-112__Gene.parquet: 16.9%... synchronizing df_human__ensembl__release-112__Gene.parquet: 19.5%... synchronizing df_human__ensembl__release-112__Gene.parquet: 22.1%... synchronizing df_human__ensembl__release-112__Gene.parquet: 24.6%... synchronizing df_human__ensembl__release-112__Gene.parquet: 27.2%... synchronizing df_human__ensembl__release-112__Gene.parquet: 29.7%... synchronizing df_human__ensembl__release-112__Gene.parquet: 32.3%... synchronizing df_human__ensembl__release-112__Gene.parquet: 34.8%... synchronizing df_human__ensembl__release-112__Gene.parquet: 37.4%... synchronizing df_human__ensembl__release-112__Gene.parquet: 40.0%... synchronizing df_human__ensembl__release-112__Gene.parquet: 42.5%... synchronizing df_human__ensembl__release-112__Gene.parquet: 45.0%... synchronizing df_human__ensembl__release-112__Gene.parquet: 47.6%... synchronizing df_human__ensembl__release-112__Gene.parquet: 50.2%... synchronizing df_human__ensembl__release-112__Gene.parquet: 52.7%... synchronizing df_human__ensembl__release-112__Gene.parquet: 55.3%... synchronizing df_human__ensembl__release-112__Gene.parquet: 57.8%... synchronizing df_human__ensembl__release-112__Gene.parquet: 60.4%... synchronizing df_human__ensembl__release-112__Gene.parquet: 63.0%... synchronizing df_human__ensembl__release-112__Gene.parquet: 65.5%... synchronizing df_human__ensembl__release-112__Gene.parquet: 68.1%... synchronizing df_human__ensembl__release-112__Gene.parquet: 70.6%... synchronizing df_human__ensembl__release-112__Gene.parquet: 73.2%... synchronizing df_human__ensembl__release-112__Gene.parquet: 75.7%... synchronizing df_human__ensembl__release-112__Gene.parquet: 78.3%... synchronizing df_human__ensembl__release-112__Gene.parquet: 80.9%... synchronizing df_human__ensembl__release-112__Gene.parquet: 83.4%... synchronizing df_human__ensembl__release-112__Gene.parquet: 85.9%... synchronizing df_human__ensembl__release-112__Gene.parquet: 88.5%... synchronizing df_human__ensembl__release-112__Gene.parquet: 91.1%... synchronizing df_human__ensembl__release-112__Gene.parquet: 93.6%... synchronizing df_human__ensembl__release-112__Gene.parquet: 96.2%... synchronizing df_human__ensembl__release-112__Gene.parquet: 98.7%... synchronizing df_human__ensembl__release-112__Gene.parquet: 100.0%
#> → returning schema with same hash: Schema(uid='1AaR6MYize150yx2', name=None, description=None, n=7, is_type=False, itype='Feature', otype=None, dtype=None, hash='RO8K-F06uyGZElLNFuqBUA', minimal_set=True, ordered_set=False, maximal_set=False, slot=None, branch_id=1, space_id=1, created_by_id=1, run_id=1, type_id=None, validated_by_id=None, composite_id=None, created_at=2025-11-11 13:52:57 UTC, is_locked=False)
artifact$describe()
#> Artifact: my_datasets/my_rnaseq1.h5ad (0000)
#> ├── uid: o1dmZn5qsl8YYKI40000            run: 2id3j2U (introduction.Rmd)
#> │   kind: dataset                        otype: AnnData                 
#> │   hash: m2P4vKb8_FC7kjyyjXh0Xg         size: 29.5 KB                  
#> │   branch: main                         space: all                     
#> │   created_at: 2025-11-11 13:54:42 UTC  created_by: testuser1          
#> │   n_observations: 3                                                   
#> ├── storage/path: 
#> │   /tmp/Rtmp92na1c/laminr-intro-20251111135047/.lamindb/o1dmZn5qsl8YYKI40000.h5
#> │   ad
#> ├── Dataset features
#> │   ├── obs (7)                                                                 
#> │   │   assay_oid           bionty.ExperimentalFa…  EFO:0008913                 
...
#>                    uid                         key description suffix    kind
#> 4 o1dmZn5qsl8YYKI40000 my_datasets/my_rnaseq1.h5ad        <NA>  .h5ad dataset
...
#> 4     FALSE 2025-11-11 13:54:42         1        1          1      1         4
#>   created_by_id
#> 4             1
```
...
#> └── uid: cI481YwT3IKl5MWX0000            run: 2id3j2U (introduction.Rmd)
#>     branch: main                         space: all                     
#>     created_at: 2025-11-11 13:54:46 UTC  created_by: testuser1
...
#> <ArtifactBasicQuerySet [Artifact(uid='o1dmZn5qsl8YYKI40000', version=None, is_latest=True, key='my_datasets/my_rnaseq1.h5ad', description=None, suffix='.h5ad', kind='dataset', otype='AnnData', size=30240, hash='m2P4vKb8_FC7kjyyjXh0Xg', n_files=None, n_observations=3, branch_id=1, space_id=1, storage_id=1, run_id=1, schema_id=4, created_by_id=1, created_at=2025-11-11 13:54:42 UTC, is_locked=False), Artifact(uid='hKw9F19pv0q4ULqg0000', version=None, is_latest=True, key='my_datasets/my_rnaseq2.h5ad', description=None, suffix='.h5ad', kind='dataset', otype='AnnData', size=23712, hash='vw0CqippRMuSj8iwUbojpQ', n_files=None, n_observations=3, branch_id=1, space_id=1, storage_id=1, run_id=1, schema_id=4, created_by_id=1, created_at=2025-11-11 13:54:45 UTC, is_locked=False)]>

# or look at a DataFrame listing the artifacts
collection$artifacts$to_dataframe()
#>                    uid                         key description suffix    kind
#> 5 hKw9F19pv0q4ULqg0000 my_datasets/my_rnaseq2.h5ad        <NA>  .h5ad dataset
#> 4 o1dmZn5qsl8YYKI40000 my_datasets/my_rnaseq1.h5ad        <NA>  .h5ad dataset
#>     otype  size                   hash n_files n_observations version is_latest
#> 5 AnnData 23712 vw0CqippRMuSj8iwUbojpQ    <NA>              3    <NA>      TRUE
#> 4 AnnData 30240 m2P4vKb8_FC7kjyyjXh0Xg    <NA>              3    <NA>      TRUE
#>   is_locked          created_at branch_id space_id storage_id run_id schema_id
#> 5     FALSE 2025-11-11 13:54:45         1        1          1      1         4
#> 4     FALSE 2025-11-11 13:54:42         1        1          1      1         4
#>   created_by_id
#> 5             1
#> 4             1
...
#> → finished Run('2id3j2U1R5c8p3vI') after 3m at 2025-11-11 13:54:47 UTC
```
