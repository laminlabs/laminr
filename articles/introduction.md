...
#> → connected lamindb: testuser1/laminr-intro-20260203155458
#> ℹ Requiring bionty
ln$track()
#> → created Transform('4mQoR6V7vpXi0000', key='introduction.Rmd'), started new Run('UrZTFIoysti5MsG9') at 2026-02-03 15:55:20 UTC
#> • recommendation: to identify the notebook across renames, pass the uid: ln$track("4mQoR6V7vpXi")

ln$Transform$to_dataframe()
#>                uid              key description     kind source_code hash
#> 1 4mQoR6V7vpXi0000 introduction.Rmd        <NA> notebook        <NA> <NA>
#>   reference reference_type version_tag is_latest is_locked          created_at
#> 1      <NA>           <NA>        <NA>      TRUE     FALSE 2026-02-03 15:55:20
#>   branch_id space_id environment_id created_by_id
#> 1         1        1           <NA>             3
ln$Run$to_dataframe()
#>                uid name entrypoint          started_at finished_at params
#> 1 UrZTFIoysti5MsG9 <NA>       <NA> 2026-02-03 15:55:20        <NA>   <NA>
#>   reference reference_type cli_args is_locked          created_at branch_id
#> 1      <NA>           <NA>     <NA>     FALSE 2026-02-03 15:55:20         1
...
#> ├── uid: 9lOVQTrCiA09notx0000            run: UrZTFIo (introduction.Rmd)
#> │   kind: dataset                        otype: DataFrame               
#> │   hash: 0MvCJV4AOs7Pya5f_lA1kg         size: 9.3 KB                   
#> │   branch: main                         space: all                     
#> │   created_at: 2026-02-03 15:55:21 UTC  created_by: testuser1          
#> │   n_observations: 3                                                   
#> └── storage/path: 
#>     /tmp/RtmpL3vjLs/laminr-intro-20260203155458/.lamindb/9lOVQTrCiA09notx0000.pa
#>     rquet
```
...
#> sample3                      Chinese
artifact$cache()
#> [1] "/tmp/RtmpL3vjLs/laminr-intro-20260203155458/.lamindb/9lOVQTrCiA09notx0000.parquet"
```
...
``` r
artifact$transform
#> Transform(uid='4mQoR6V7vpXi0000', version_tag=None, is_latest=True, key='introduction.Rmd', description=None, kind='notebook', hash=None, reference=None, reference_type=None, environment=None, branch_id=1, space_id=1, created_by_id=3, created_at=2026-02-03 15:55:20 UTC, is_locked=False)
artifact$run
#> Run(uid='UrZTFIoysti5MsG9', name=None, entrypoint=None, started_at=2026-02-03 15:55:20 UTC, finished_at=None, params=None, reference=None, reference_type=None, cli_args=None, branch_id=1, space_id=1, transform_id=1, report_id=None, environment_id=None, created_by_id=3, initiated_by_run_id=None, created_at=2026-02-03 15:55:20 UTC, is_locked=False)
...
#> 1 9lOVQTrCiA09notx0000 my_datasets/rnaseq1.parquet        <NA> .parquet dataset
...
#> 1      TRUE     FALSE 2026-02-03 15:55:21         1        1          3      1
...
#> Feature(uid='G5r5zc7GBzf9', is_type=False, name='temperature', _dtype_str='float', unit=None, description=None, array_rank=0, array_size=0, array_shape=None, synonyms=None, default_value=None, nullable=True, coerce=None, branch_id=1, space_id=1, created_by_id=3, run_id=1, type_id=None, created_at=2026-02-03 15:55:42 UTC, is_locked=False)
ln$Feature(name = "experiment", dtype = ln$Record)$save()
#> Feature(uid='QztpnpH75erE', is_type=False, name='experiment', _dtype_str='cat[Record]', unit=None, description=None, array_rank=0, array_size=0, array_shape=None, synonyms=None, default_value=None, nullable=True, coerce=None, branch_id=1, space_id=1, created_by_id=3, run_id=1, type_id=None, created_at=2026-02-03 15:55:42 UTC, is_locked=False)
...
#> Record(uid='LhrsfQ4vnrPxfxXC', is_type=False, name='DMSO', description=None, reference=None, reference_type=None, extra_data=None, branch_id=1, space_id=1, created_by_id=3, type_id=None, schema_id=None, run_id=1, created_at=2026-02-03 15:55:42 UTC, is_locked=False)
ln$Record(name = "IFNG")$save()
#> Record(uid='bdRlZpWsZ0T74iTu', is_type=False, name='IFNG', description=None, reference=None, reference_type=None, extra_data=None, branch_id=1, space_id=1, created_by_id=3, type_id=None, schema_id=None, run_id=1, created_at=2026-02-03 15:55:43 UTC, is_locked=False)

# define a few more valid features
ln$Feature(name = "perturbation", dtype = ln$Record)$save()
#> Feature(uid='qyugxzDPDR51', is_type=False, name='perturbation', _dtype_str='cat[Record]', unit=None, description=None, array_rank=0, array_size=0, array_shape=None, synonyms=None, default_value=None, nullable=True, coerce=None, branch_id=1, space_id=1, created_by_id=3, run_id=1, type_id=None, created_at=2026-02-03 15:55:43 UTC, is_locked=False)
ln$Feature(name = "cell_type_by_model", dtype = bt$CellType)$save()
#> Feature(uid='ZBhYc2MXJlkD', is_type=False, name='cell_type_by_model', _dtype_str='cat[bionty.CellType]', unit=None, description=None, array_rank=0, array_size=0, array_shape=None, synonyms=None, default_value=None, nullable=True, coerce=None, branch_id=1, space_id=1, created_by_id=3, run_id=1, type_id=None, created_at=2026-02-03 15:55:43 UTC, is_locked=False)
ln$Feature(name = "cell_type_by_expert", dtype = bt$CellType)$save()
#> Feature(uid='HNLnUHz67eDC', is_type=False, name='cell_type_by_expert', _dtype_str='cat[bionty.CellType]', unit=None, description=None, array_rank=0, array_size=0, array_shape=None, synonyms=None, default_value=None, nullable=True, coerce=None, branch_id=1, space_id=1, created_by_id=3, run_id=1, type_id=None, created_at=2026-02-03 15:55:43 UTC, is_locked=False)
ln$Feature(name = "assay_oid", dtype = bt$ExperimentalFactor$ontology_id)$save()
#> Feature(uid='UPUMYAcAOtMm', is_type=False, name='assay_oid', _dtype_str='cat[bionty.ExperimentalFactor.ontology_id]', unit=None, description=None, array_rank=0, array_size=0, array_shape=None, synonyms=None, default_value=None, nullable=True, coerce=None, branch_id=1, space_id=1, created_by_id=3, run_id=1, type_id=None, created_at=2026-02-03 15:55:44 UTC, is_locked=False)
ln$Feature(name = "donor", dtype = "str", nullable = TRUE)$save()
#> ! rather than passing a string 'str' to dtype, consider passing a Python object
#> Feature(uid='Y6EtaZqNDXsB', is_type=False, name='donor', _dtype_str='str', unit=None, description=None, array_rank=0, array_size=0, array_shape=None, synonyms=None, default_value=None, nullable=True, coerce=None, branch_id=1, space_id=1, created_by_id=3, run_id=1, type_id=None, created_at=2026-02-03 15:55:44 UTC, is_locked=False)
ln$Feature(name = "concentration", dtype = "str")$save()
#> ! rather than passing a string 'str' to dtype, consider passing a Python object
#> Feature(uid='H4PO7dqYtysh', is_type=False, name='concentration', _dtype_str='str', unit=None, description=None, array_rank=0, array_size=0, array_shape=None, synonyms=None, default_value=None, nullable=True, coerce=None, branch_id=1, space_id=1, created_by_id=3, run_id=1, type_id=None, created_at=2026-02-03 15:55:44 UTC, is_locked=False)
ln$Feature(name = "treatment_time_h", dtype = "num", coerce_dtype = TRUE)$save()
#> Feature(uid='jtQLWEw2hfG5', is_type=False, name='treatment_time_h', _dtype_str='num', unit=None, description=None, array_rank=0, array_size=0, array_shape=None, synonyms=None, default_value=None, nullable=True, coerce=True, branch_id=1, space_id=1, created_by_id=3, run_id=1, type_id=None, created_at=2026-02-03 15:55:44 UTC, is_locked=False)
...
#> → writing the in-memory object into cache
#> → returning artifact with same hash: Artifact(uid='9lOVQTrCiA09notx0000', version_tag=None, is_latest=True, key='my_datasets/rnaseq1.parquet', description=None, suffix='.parquet', kind='dataset', otype='DataFrame', size=9491, hash='0MvCJV4AOs7Pya5f_lA1kg', n_files=None, n_observations=3, branch_id=1, space_id=1, storage_id=3, run_id=1, schema_id=None, created_by_id=3, created_at=2026-02-03 15:55:21 UTC, is_locked=False); to track this artifact as an input, use: ln.Artifact.get()
#> → loading artifact into memory for validation
#> ! 5 terms not validated in feature 'columns': 'sample_note', 'ENSG00000153563', 'ENSG00000010610', 'ENSG00000170458', 'donor_ethnicity'
...
#> ... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet:  0.0%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet:  0.9%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet:  4.5%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet:  6.4%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 10.0%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 13.6%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 17.2%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 20.2%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 23.8%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 27.4%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 31.0%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 34.5%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 38.1%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 41.7%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 45.4%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 48.9%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 52.5%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 56.1%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 59.7%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 63.3%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 66.9%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 70.5%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 74.1%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 77.6%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 81.2%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 84.8%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 88.4%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 92.0%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 92.9%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 96.5%... synchronizing df_all__efo__3.85.0__ExperimentalFactor.parquet: 100.0%
```
...
#> → writing the in-memory object into cache
#> → creating new artifact version for key 'my_datasets/rnaseq1.parquet' in storage '/tmp/RtmpL3vjLs/laminr-intro-20260203155458'
#> → loading artifact into memory for validation
#> ! 5 terms not validated in feature 'columns': 'sample_note', 'ENSG00000153563', 'ENSG00000010610', 'ENSG00000170458', 'donor_ethnicity'
#>     → fix typos, remove non-existent values, or save terms via: curator.cat.add_new_from('columns')
...
#> ├── uid: 9lOVQTrCiA09notx0001            run: UrZTFIo (introduction.Rmd)
#> │   kind: dataset                        otype: DataFrame               
#> │   hash: -3UQHfEeTY8xPhXedCpW1Q         size: 9.3 KB                   
#> │   branch: main                         space: all                     
#> │   created_at: 2026-02-03 15:56:50 UTC  created_by: testuser1          
#> │   n_observations: 3                                                   
#> ├── storage/path: 
#> │   /tmp/RtmpL3vjLs/laminr-intro-20260203155458/.lamindb/9lOVQTrCiA09notx0001.pa
#> │   rquet
#> ├── Dataset features
#> │   └── columns (7)                                                             
...
#> 2 9lOVQTrCiA09notx0001 my_datasets/rnaseq1.parquet         NaN          <NA>
#> 1 9lOVQTrCiA09notx0000 my_datasets/rnaseq1.parquet        21.6 My experiment
#>                    perturbation
#> 2 <environment: 0x5633355f7390>
#> 1                           NaN
ln$Artifact
...
#> id                                                                            
#> 2   9lOVQTrCiA09notx0001  my_datasets/rnaseq1.parquet        None  .parquet   
#> 1   9lOVQTrCiA09notx0000  my_datasets/rnaseq1.parquet        None  .parquet   
#> 
...
#> id                                                                      
#> 2         None       True      False 2026-02-03 15:56:50.576000+00:00   
#> 1         None      False      False 2026-02-03 15:55:21.573000+00:00   
#> 
...
#>              uid                 name  \
#> id                                      
#> 9   jtQLWEw2hfG5     treatment_time_h   
#> 8   H4PO7dqYtysh        concentration   
#> 7   Y6EtaZqNDXsB                donor   
#> 6   UPUMYAcAOtMm            assay_oid   
#> 5   HNLnUHz67eDC  cell_type_by_expert   
#> 4   ZBhYc2MXJlkD   cell_type_by_model   
#> 3   qyugxzDPDR51         perturbation   
#> 
...
#> id                                                                  
#> 9     False 2026-02-03 15:55:44.764000+00:00          1         1   
#> 8     False 2026-02-03 15:55:44.419000+00:00          1         1   
#> 7     False 2026-02-03 15:55:44.283000+00:00          1         1   
#> 6     False 2026-02-03 15:55:44.144000+00:00          1         1   
#> 5     False 2026-02-03 15:55:43.915000+00:00          1         1   
#> 4     False 2026-02-03 15:55:43.679000+00:00          1         1   
#> 3     False 2026-02-03 15:55:43.453000+00:00          1         1   
#> 
...
#> id                                                                              
#> 1    21.6  XftFE5byhwPHY-11WjfNAw      False 2026-02-03 15:55:42.520000+00:00   
#> 
...
#> id                                                                         
#> 3   bdRlZpWsZ0T74iTu           IFNG        None      None           None   
#> 2   LhrsfQ4vnrPxfxXC           DMSO        None      None           None   
#> 1   RGN1X4fMfPCBNBQu  My experiment        None      None           None   
#> 
#>    extra_data  is_locked  is_type                       created_at  branch_id  \
#> id                                                                              
#> 3        None      False    False 2026-02-03 15:55:43.039000+00:00          1   
#> 2        None      False    False 2026-02-03 15:55:42.912000+00:00          1   
#> 1        None      False    False 2026-02-03 15:55:24.053000+00:00          1   
#> 
...
#> id                                                                       
#> 1   UrZTFIoysti5MsG9  None       None 2026-02-03 15:55:20.410887+00:00   
#> 
...
#> id                                                                       
#> 1  2026-02-03 15:55:20.411000+00:00          1         1             1   
#> 
...
#> id                                                                            
#> 2   ASfbbcaAZC45Plfh  None        None        7.0   None     False  Feature   
#> 1   0000000000000000  None        None        NaN   None      True  Feature   
#> 
#>    otype                    hash  minimal_set  ordered_set  maximal_set  \
#> id                                                                        
#> 2   None  LWobo7CPHSQMvHr0iHzzsg         True        False        False   
#> 1   None  kMi7B_N88uu-YnbTLDU-DA         True        False        False   
#> 
#>     is_locked  is_type                       created_at  branch_id  space_id  \
#> id                                                                             
#> 2       False    False 2026-02-03 15:56:50.595000+00:00          1         1   
#> 1       False    False 2026-02-03 15:55:45.002000+00:00          1         1   
#> 
#>     created_by_id  run_id type_id  
#> id                                 
#> 2               3       1    None  
...
#> id                                                                          
#> 3   QrPgPy985pRA  /tmp/RtmpL3vjLs/laminr-intro-20260203155458        None   
#> 
#>      type region  instance_uid  is_locked                       created_at  \
#> id                                                                           
#> 3   local   None  51rUP1ycxtiO      False 2026-02-03 15:55:11.363000+00:00   
#> 
...
#> id                                                                         
#> 1   4mQoR6V7vpXi0000  introduction.Rmd        None  notebook        None   
#> 
...
#> id                                                                        
#> 1  2026-02-03 15:55:20.406000+00:00          1         1           None   
#> 
#>     created_by_id  
#> id                 
#> 1               3  
...
#> id                                                                        
#> 17 2026-02-03 15:55:46.824000+00:00          1         1              3   
#> 16 2026-02-03 15:55:46.824000+00:00          1         1              3   
#> 15 2026-02-03 15:55:46.483000+00:00          1         1              3   
#> 14 2026-02-03 15:55:46.100000+00:00          1         1              3   
#> 13 2026-02-03 15:55:45.754000+00:00          1         1              3   
#> 12 2026-02-03 15:55:41.827000+00:00          1         1              3   
#> 11 2026-02-03 15:55:41.827000+00:00          1         1              3   
#> 
#>     run_id  source_id  
#> id                     
#> 17       1         50  
...
#>                          created_at  branch_id  space_id  created_by_id  \
#> id                                                                        
#> 6  2026-02-03 15:56:49.609000+00:00          1         1              3   
#> 5  2026-02-03 15:56:49.609000+00:00          1         1              3   
#> 4  2026-02-03 15:56:49.609000+00:00          1         1              3   
#> 3  2026-02-03 15:56:49.609000+00:00          1         1              3   
#> 2  2026-02-03 15:56:49.609000+00:00          1         1              3   
#> 1  2026-02-03 15:56:49.234000+00:00          1         1              3   
#> 
#>     run_id  source_id  
#> id                     
#> 6        1         55  
...
#>                          created_at  branch_id  space_id  created_by_id  \
#> id                                                                        
#> 67 2026-02-03 15:55:11.446000+00:00          1         1              3   
#> 66 2026-02-03 15:55:11.446000+00:00          1         1              3   
#> 65 2026-02-03 15:55:11.446000+00:00          1         1              3   
#> 64 2026-02-03 15:55:11.446000+00:00          1         1              3   
#> 63 2026-02-03 15:55:11.446000+00:00          1         1              3   
#> 62 2026-02-03 15:55:11.446000+00:00          1         1              3   
#> 61 2026-02-03 15:55:11.446000+00:00          1         1              3   
#> 
...
#> 3 QrPgPy985pRA /tmp/RtmpL3vjLs/laminr-intro-20260203155458        <NA> local
#>      region instance_uid is_locked          created_at branch_id space_id
#> 4 us-east-1 4XIuR0tvaiXM     FALSE 2026-02-03 15:56:56         1        1
#> 3      <NA> 51rUP1ycxtiO     FALSE 2026-02-03 15:55:11         1        1
...
#>                    uid                         key description suffix    kind
#> 4 mW5dM453pMYP4PXu0000 my_datasets/my_rnaseq1.h5ad        <NA>  .h5ad dataset
#>     otype  size                   hash n_files n_observations version_tag
#> 4 AnnData 30240 m2P4vKb8_FC7kjyyjXh0Xg    <NA>              3        <NA>
#>   is_latest is_locked          created_at branch_id space_id storage_id run_id
#> 4      TRUE     FALSE 2026-02-03 15:58:46         1        1          3      1
#>   schema_id created_by_id
#> 4         4             3
```
...
#> └── uid: GuYifdddMoISCgiZ0000            run: UrZTFIo (introduction.Rmd)
#>     branch: main                         space: all                     
#>     created_at: 2026-02-03 15:58:50 UTC  created_by: testuser1
...
#> <ArtifactBasicQuerySet [Artifact(uid='mW5dM453pMYP4PXu0000', version_tag=None, is_latest=True, key='my_datasets/my_rnaseq1.h5ad', description=None, suffix='.h5ad', kind='dataset', otype='AnnData', size=30240, hash='m2P4vKb8_FC7kjyyjXh0Xg', n_files=None, n_observations=3, branch_id=1, space_id=1, storage_id=3, run_id=1, schema_id=4, created_by_id=3, created_at=2026-02-03 15:58:46 UTC, is_locked=False), Artifact(uid='Ldps5rpzoM0wefDD0000', version_tag=None, is_latest=True, key='my_datasets/my_rnaseq2.h5ad', description=None, suffix='.h5ad', kind='dataset', otype='AnnData', size=23712, hash='vw0CqippRMuSj8iwUbojpQ', n_files=None, n_observations=3, branch_id=1, space_id=1, storage_id=3, run_id=1, schema_id=4, created_by_id=3, created_at=2026-02-03 15:58:49 UTC, is_locked=False)]>

# or look at a DataFrame listing the artifacts
collection$artifacts$to_dataframe()
#>                    uid                         key description suffix    kind
#> 5 Ldps5rpzoM0wefDD0000 my_datasets/my_rnaseq2.h5ad        <NA>  .h5ad dataset
#> 4 mW5dM453pMYP4PXu0000 my_datasets/my_rnaseq1.h5ad        <NA>  .h5ad dataset
#>     otype  size                   hash n_files n_observations version_tag
#> 5 AnnData 23712 vw0CqippRMuSj8iwUbojpQ    <NA>              3        <NA>
#> 4 AnnData 30240 m2P4vKb8_FC7kjyyjXh0Xg    <NA>              3        <NA>
#>   is_latest is_locked          created_at branch_id space_id storage_id run_id
#> 5      TRUE     FALSE 2026-02-03 15:58:49         1        1          3      1
#> 4      TRUE     FALSE 2026-02-03 15:58:46         1        1          3      1
#>   schema_id created_by_id
#> 5         4             3
#> 4         4             3
...
#> → finished Run('UrZTFIoysti5MsG9') after 3m at 2026-02-03 15:58:51 UTC
```
