...
laminr::create_temporary_instance(name = "laminr-intro", modules = c("bionty"))
...
ln <- laminr::import_module("lamindb")  # import lamindb, this will install Pythin dependencies
lc <- laminr::import_module("lamin_cli")  # import lamin_cli for access to CLI commands
lc$login()  # <-- you can skip this for local & self-hosted instances
lc$connect("<account>/<instance>")  # <-- replace with your instance
```
...
lc$init(storage = "./laminr-intro", modules = c("bionty"))
```
