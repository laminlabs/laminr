...
* [ ] **Load artifacts**: Load artifacts from LaminDB into R:
  ...
  - [ ] `h5ad`: Load an HDF5-backed AnnData object.
  - [ ] `h5mu`: Load an HDF5-backed MuData object.
...
* [ ] **Cache artifacts**: Cache artifacts locally for faster access:
  ...
  - [ ] `gcp`: Store artifacts in Google Cloud Storage.
...
* [ ] **Download data**: Download data files from LaminDB storage.
