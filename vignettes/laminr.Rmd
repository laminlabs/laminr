...
You can fetch a specific artifact using its ID or UID. For instance, to get the artifact with UID [KBW89Mf7IGcekja2hADu](https://lamin.ai/laminlabs/cellxgene/artifact/KBW89Mf7IGcekja2hADu):
...
Access specific fields of the artifact using the `$` operator:
...
You can also access related data:

```{r access_related_data}
artifact$storage
artifact$created_by
```

Finally, you can download the actual data associated with the artifact:
